...
var RadialRepeatItem = {
     ...
     * @readonly
     */
    radialConfig: RadialRepeatConfig,
     ...
     *
     * @param {RadialRepeatConfig} [config] Updated radial repeat configuration.
     * @param {RadialRepeatUpdate} [state] Specify which properties of radial repeat gets updated.
     * @return undefined
     */
    setRadialConfiguration: function (config, state) {
