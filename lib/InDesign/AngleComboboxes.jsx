...
var AngleComboboxes = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new AngleCombobox (Optional)
     ...
     *
     * @param {varies=any} [from] The AngleCombobox, index, or name at the beginning of the range. Can accept: AngleCombobox, Long Integer or String.
     * @param {varies=any} [to] The AngleCombobox, index, or name at the end of the range. Can accept: AngleCombobox, Long Integer or String.
     * @return AngleCombobox
     */
