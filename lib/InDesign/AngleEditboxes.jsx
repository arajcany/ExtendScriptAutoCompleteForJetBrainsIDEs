...
var AngleEditboxes = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new AngleEditbox (Optional)
     * @return AngleEditbox
     */
     ...
     *
     * @param {varies=any} [from] The AngleEditbox, index, or name at the beginning of the range. Can accept: AngleEditbox, Long Integer or String.
     * @param {varies=any} [to] The AngleEditbox, index, or name at the end of the range. Can accept: AngleEditbox, Long Integer or String.
     * @return AngleEditbox
     */
