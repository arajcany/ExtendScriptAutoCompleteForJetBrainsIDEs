...
var AnimationBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new AnimationBehavior (Optional)
     ...
     *
     * @param {varies=any} [from] The AnimationBehavior, index, or name at the beginning of the range. Can accept: AnimationBehavior, Long Integer or String.
     * @param {varies=any} [to] The AnimationBehavior, index, or name at the end of the range. Can accept: AnimationBehavior, Long Integer or String.
     * @return AnimationBehavior
     */
