...
var ArticleChildren = {
     ...
     *
     * @param {varies=any} [from] The ArticleChild, index, or name at the beginning of the range. Can accept: ArticleChild, Long Integer or String.
     * @param {varies=any} [to] The ArticleChild, index, or name at the end of the range. Can accept: ArticleChild, Long Integer or String.
     * @return ArticleChild
     */
