...
var ArticleMembers = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new ArticleMember (Optional)
     ...
     *
     * @param {varies=any} [from] The ArticleMember, index, or name at the beginning of the range. Can accept: ArticleMember, Long Integer or String.
     * @param {varies=any} [to] The ArticleMember, index, or name at the end of the range. Can accept: ArticleMember, Long Integer or String.
     * @return ArticleMember
     */
