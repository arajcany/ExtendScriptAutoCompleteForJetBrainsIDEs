...
var AssignedStories = {
     ...
     *
     * @param {varies=any} [from] The AssignedStory, index, or name at the beginning of the range. Can accept: AssignedStory, Long Integer or String.
     * @param {varies=any} [to] The AssignedStory, index, or name at the end of the range. Can accept: AssignedStory, Long Integer or String.
     * @return AssignedStory
     */
