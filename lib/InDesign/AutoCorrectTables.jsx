...
var AutoCorrectTables = {
     ...
     *
     * @param {varies=any} [from] The AutoCorrectTable, index, or name at the beginning of the range. Can accept: AutoCorrectTable, Long Integer or String.
     * @param {varies=any} [to] The AutoCorrectTable, index, or name at the end of the range. Can accept: AutoCorrectTable, Long Integer or String.
     * @return AutoCorrectTable
     */
