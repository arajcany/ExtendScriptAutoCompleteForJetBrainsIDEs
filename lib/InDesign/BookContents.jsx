...
var BookContents = {
     ...
     * @param {number} [at] The location of the book content object within the book. (Optional) (default: -1)
     * @param {Object} [withProperties] Initial values for properties of the new BookContent (Optional)
     * @return BookContent
     */
     ...
     *
     * @param {varies=any} [from] The BookContent, index, or name at the beginning of the range. Can accept: BookContent, Long Integer or String.
     * @param {varies=any} [to] The BookContent, index, or name at the end of the range. Can accept: BookContent, Long Integer or String.
     * @return BookContent
     */
