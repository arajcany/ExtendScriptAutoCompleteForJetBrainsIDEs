...
var Books = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new Book (Optional)
     * @return Book
     */
     ...
     *
     * @param {varies=any} [from] The Book, index, or name at the beginning of the range. Can accept: Book, Long Integer or String.
     * @param {varies=any} [to] The Book, index, or name at the end of the range. Can accept: Book, Long Integer or String.
     * @return Book
     */
