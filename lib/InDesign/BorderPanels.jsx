...
var BorderPanels = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new BorderPanel (Optional)
     * @return BorderPanel
     */
     ...
     *
     * @param {varies=any} [from] The BorderPanel, index, or name at the beginning of the range. Can accept: BorderPanel, Long Integer or String.
     * @param {varies=any} [to] The BorderPanel, index, or name at the end of the range. Can accept: BorderPanel, Long Integer or String.
     * @return BorderPanel
     */
