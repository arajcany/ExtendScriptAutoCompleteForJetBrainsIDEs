...
var Button = {
    ...
    /**
     * Dispatched before a Button is placed. This event bubbles. This event is cancelable.
     * @type {string}
     * @readonly
     */
    ...
    /**
     * Dispatched after a Button is placed. This event bubbles. This event is not cancelable.
     * @type {string}
     * @readonly
     */
     ...
     * @param {Object} [withProperties] Initial values for properties of the new Button (Optional)
     * @return Asset
     */
     ...
     * Flips the Button.
     *
     * @param {Flip} [given] The axis around which to flip the Button.
     * @param {varies=any} [around] The point around which to flip the Button. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional)
     * @return undefined
     */
     ...
     *
     * @param {varies=any} [to] The location of the new Button, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] Amount by which to offset the new Button from the original Button's position. (Optional)
     * @return PageItem
     */
     ...
     *
     * @param {varies=any} [to] The new location of the Button,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] The amount (in measurement units) to move the Button relative to its current position, in the format (x, y). (Optional)
     * @return undefined
     */
    move: function (to, by) {
     ...
     * @param {boolean} [clearingOverrides] If true, clears the Button's existing attributes before applying the style. (Optional) (default: true)
     * @param {boolean} [clearingOverridesThroughRootObjectStyle] If true, clears attributes and formatting applied to the Button that are not defined in the object style. (Optional) (default: false)
     * @return undefined
     */
     ...
     * @param {string} [withProperties] Initial values for properties of the new Button. Above parameters can also be passed as properties (Optional)
     * @return undefined
     */
     ...
     * Selects the object.
     *
     * @param {SelectionOptions} [existingSelection] The selection status of the Button in relation to previously selected objects. (Optional) (default: SelectionOptions.REPLACE_WITH)
     * @return undefined
     */
