...
var CellStyleGroups = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new CellStyleGroup (Optional)
     ...
     *
     * @param {varies=any} [from] The CellStyleGroup, index, or name at the beginning of the range. Can accept: CellStyleGroup, Long Integer or String.
     * @param {varies=any} [to] The CellStyleGroup, index, or name at the end of the range. Can accept: CellStyleGroup, Long Integer or String.
     * @return CellStyleGroup
     */
