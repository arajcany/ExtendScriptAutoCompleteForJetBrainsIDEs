...
var CellStyleMappings = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new CellStyleMapping (Optional)
     ...
     *
     * @param {varies=any} [from] The CellStyleMapping, index, or name at the beginning of the range. Can accept: CellStyleMapping, Long Integer or String.
     * @param {varies=any} [to] The CellStyleMapping, index, or name at the end of the range. Can accept: CellStyleMapping, Long Integer or String.
     * @return CellStyleMapping
     */
