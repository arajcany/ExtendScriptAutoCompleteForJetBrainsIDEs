...
var CellStyles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new CellStyle (Optional)
     * @return CellStyle
     */
     ...
     *
     * @param {varies=any} [from] The CellStyle, index, or name at the beginning of the range. Can accept: CellStyle, Long Integer or String.
     * @param {varies=any} [to] The CellStyle, index, or name at the end of the range. Can accept: CellStyle, Long Integer or String.
     * @return CellStyle
     */
