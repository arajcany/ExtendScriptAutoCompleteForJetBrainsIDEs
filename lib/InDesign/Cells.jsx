...
var Cells = {
     ...
     *
     * @param {varies=any} [from] The Cell, index, or name at the beginning of the range. Can accept: Cell, Long Integer or String.
     * @param {varies=any} [to] The Cell, index, or name at the end of the range. Can accept: Cell, Long Integer or String.
     * @return Cell
     */
