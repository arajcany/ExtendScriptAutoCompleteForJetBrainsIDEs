...
var Changes = {
     ...
     *
     * @param {varies=any} [from] The Change, index, or name at the beginning of the range. Can accept: Change, Long Integer or String.
     * @param {varies=any} [to] The Change, index, or name at the end of the range. Can accept: Change, Long Integer or String.
     * @return Change
     */
