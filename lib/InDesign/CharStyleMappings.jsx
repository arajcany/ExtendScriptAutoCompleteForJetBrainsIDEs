...
var CharStyleMappings = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new CharStyleMapping (Optional)
     * @return CharStyleMapping
     */
     ...
     *
     * @param {varies=any} [from] The CharStyleMapping, index, or name at the beginning of the range. Can accept: CharStyleMapping, Long Integer or String.
     * @param {varies=any} [to] The CharStyleMapping, index, or name at the end of the range. Can accept: CharStyleMapping, Long Integer or String.
     * @return CharStyleMapping
     */
