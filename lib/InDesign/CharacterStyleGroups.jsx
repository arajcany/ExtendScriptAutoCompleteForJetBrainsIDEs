...
var CharacterStyleGroups = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new CharacterStyleGroup (Optional)
     ...
     *
     * @param {varies=any} [from] The CharacterStyleGroup, index, or name at the beginning of the range. Can accept: CharacterStyleGroup, Long Integer or String.
     * @param {varies=any} [to] The CharacterStyleGroup, index, or name at the end of the range. Can accept: CharacterStyleGroup, Long Integer or String.
     * @return CharacterStyleGroup
     */
