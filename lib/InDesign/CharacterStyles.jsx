...
var CharacterStyles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new CharacterStyle (Optional)
     ...
     *
     * @param {varies=any} [from] The CharacterStyle, index, or name at the beginning of the range. Can accept: CharacterStyle, Long Integer or String.
     * @param {varies=any} [to] The CharacterStyle, index, or name at the end of the range. Can accept: CharacterStyle, Long Integer or String.
     * @return CharacterStyle
     */
