...
var Characters = {
     ...
     *
     * @param {varies=any} [from] The Character, index, or name at the beginning of the range. Can accept: Character, Long Integer or String.
     * @param {varies=any} [to] The Character, index, or name at the end of the range. Can accept: Character, Long Integer or String.
     * @return Character
     */
