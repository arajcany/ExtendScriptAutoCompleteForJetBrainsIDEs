...
var CheckboxControls = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new CheckboxControl (Optional)
     ...
     *
     * @param {varies=any} [from] The CheckboxControl, index, or name at the beginning of the range. Can accept: CheckboxControl, Long Integer or String.
     * @param {varies=any} [to] The CheckboxControl, index, or name at the end of the range. Can accept: CheckboxControl, Long Integer or String.
     * @return CheckboxControl
     */
