...
var ClearFormBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new ClearFormBehavior (Optional)
     * @return ClearFormBehavior
     */
     ...
     *
     * @param {varies=any} [from] The ClearFormBehavior, index, or name at the beginning of the range. Can accept: ClearFormBehavior, Long Integer or String.
     * @param {varies=any} [to] The ClearFormBehavior, index, or name at the end of the range. Can accept: ClearFormBehavior, Long Integer or String.
     * @return ClearFormBehavior
     */
