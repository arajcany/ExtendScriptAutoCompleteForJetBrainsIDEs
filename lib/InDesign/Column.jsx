...
var Column = {
     ...
     * @param {varies=any} [thru] The last Column in the range. Can accept: Cell, Column or Row. (Optional)
     * @return undefined
     */
     ...
     * Selects the object.
     *
     * @param {SelectionOptions} [existingSelection] The selection status of the Column in relation to previously selected objects. (Optional) (default: SelectionOptions.REPLACE_WITH)
     * @return undefined
     */
