...
var CompositeFontEntries = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new CompositeFontEntry (Optional)
     ...
     *
     * @param {varies=any} [from] The CompositeFontEntry, index, or name at the beginning of the range. Can accept: CompositeFontEntry, Long Integer or String.
     * @param {varies=any} [to] The CompositeFontEntry, index, or name at the end of the range. Can accept: CompositeFontEntry, Long Integer or String.
     * @return CompositeFontEntry
     */
