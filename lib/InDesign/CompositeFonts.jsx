...
var CompositeFonts = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new CompositeFont (Optional)
     ...
     *
     * @param {varies=any} [from] The CompositeFont, index, or name at the beginning of the range. Can accept: CompositeFont, Long Integer or String.
     * @param {varies=any} [to] The CompositeFont, index, or name at the end of the range. Can accept: CompositeFont, Long Integer or String.
     * @return CompositeFont
     */
