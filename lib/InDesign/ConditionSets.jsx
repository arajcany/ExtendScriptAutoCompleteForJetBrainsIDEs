...
var ConditionSets = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new ConditionSet (Optional)
     * @return ConditionSet
     */
     ...
     *
     * @param {varies=any} [from] The ConditionSet, index, or name at the beginning of the range. Can accept: ConditionSet, Long Integer or String.
     * @param {varies=any} [to] The ConditionSet, index, or name at the end of the range. Can accept: ConditionSet, Long Integer or String.
     * @return ConditionSet
     */
