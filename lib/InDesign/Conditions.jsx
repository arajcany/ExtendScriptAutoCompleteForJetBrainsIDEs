...
var Conditions = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new Condition (Optional)
     * @return Condition
     */
     ...
     *
     * @param {varies=any} [from] The Condition, index, or name at the beginning of the range. Can accept: Condition, Long Integer or String.
     * @param {varies=any} [to] The Condition, index, or name at the end of the range. Can accept: Condition, Long Integer or String.
     * @return Condition
     */
