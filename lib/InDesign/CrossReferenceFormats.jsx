...
var CrossReferenceFormats = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new CrossReferenceFormat (Optional)
     * @return CrossReferenceFormat
     */
     ...
     *
     * @param {varies=any} [from] The CrossReferenceFormat, index, or name at the beginning of the range. Can accept: CrossReferenceFormat, Long Integer or String.
     * @param {varies=any} [to] The CrossReferenceFormat, index, or name at the end of the range. Can accept: CrossReferenceFormat, Long Integer or String.
     * @return CrossReferenceFormat
     */
