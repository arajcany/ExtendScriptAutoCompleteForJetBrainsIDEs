...
var CrossReferenceSources = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new CrossReferenceSource (Optional)
     ...
     *
     * @param {varies=any} [from] The CrossReferenceSource, index, or name at the beginning of the range. Can accept: CrossReferenceSource, Long Integer or String.
     * @param {varies=any} [to] The CrossReferenceSource, index, or name at the end of the range. Can accept: CrossReferenceSource, Long Integer or String.
     * @return CrossReferenceSource
     */
