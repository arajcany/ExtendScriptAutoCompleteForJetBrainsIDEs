...
var DTDs = {
     ...
     *
     * @param {varies=any} [from] The DTD, index, or name at the beginning of the range. Can accept: DTD, Long Integer or String.
     * @param {varies=any} [to] The DTD, index, or name at the end of the range. Can accept: DTD, Long Integer or String.
     * @return DTD
     */
