...
var DashedStrokeStyles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new DashedStrokeStyle (Optional)
     ...
     *
     * @param {varies=any} [from] The DashedStrokeStyle, index, or name at the beginning of the range. Can accept: DashedStrokeStyle, Long Integer or String.
     * @param {varies=any} [to] The DashedStrokeStyle, index, or name at the end of the range. Can accept: DashedStrokeStyle, Long Integer or String.
     * @return DashedStrokeStyle
     */
