...
var DataMergeFields = {
     ...
     *
     * @param {varies=any} [from] The DataMergeField, index, or name at the beginning of the range. Can accept: DataMergeField, Long Integer or String.
     * @param {varies=any} [to] The DataMergeField, index, or name at the end of the range. Can accept: DataMergeField, Long Integer or String.
     * @return DataMergeField
     */
