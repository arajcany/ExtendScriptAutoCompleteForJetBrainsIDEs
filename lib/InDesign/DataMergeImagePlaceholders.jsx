...
var DataMergeImagePlaceholders = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new DataMergeImagePlaceholder (Optional)
     * @return DataMergeImagePlaceholder
     */
     ...
     *
     * @param {varies=any} [from] The DataMergeImagePlaceholder, index, or name at the beginning of the range. Can accept: DataMergeImagePlaceholder, Long Integer or String.
     * @param {varies=any} [to] The DataMergeImagePlaceholder, index, or name at the end of the range. Can accept: DataMergeImagePlaceholder, Long Integer or String.
     * @return DataMergeImagePlaceholder
     */
