...
var DataMergeTextPlaceholders = {
     ...
     * @param {varies=any} [storyOffset] The position within the story at which to insert the placeholder, specified as an offset number or an insertion point. Can accept: InsertionPoint or Long Integer.
     * @param {DataMergeField} [field] The field to insert.
     * @param {Object} [withProperties] Initial values for properties of the new DataMergeTextPlaceholder (Optional)
     ...
     *
     * @param {varies=any} [from] The DataMergeTextPlaceholder, index, or name at the beginning of the range. Can accept: DataMergeTextPlaceholder, Long Integer or String.
     * @param {varies=any} [to] The DataMergeTextPlaceholder, index, or name at the end of the range. Can accept: DataMergeTextPlaceholder, Long Integer or String.
     * @return DataMergeTextPlaceholder
     */
