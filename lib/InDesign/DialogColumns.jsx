...
var DialogColumns = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new DialogColumn (Optional)
     * @return DialogColumn
     */
     ...
     *
     * @param {varies=any} [from] The DialogColumn, index, or name at the beginning of the range. Can accept: DialogColumn, Long Integer or String.
     * @param {varies=any} [to] The DialogColumn, index, or name at the end of the range. Can accept: DialogColumn, Long Integer or String.
     * @return DialogColumn
     */
