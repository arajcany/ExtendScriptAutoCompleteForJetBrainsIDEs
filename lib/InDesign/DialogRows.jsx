...
var DialogRows = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new DialogRow (Optional)
     * @return DialogRow
     */
     ...
     *
     * @param {varies=any} [from] The DialogRow, index, or name at the beginning of the range. Can accept: DialogRow, Long Integer or String.
     * @param {varies=any} [to] The DialogRow, index, or name at the end of the range. Can accept: DialogRow, Long Integer or String.
     * @return DialogRow
     */
