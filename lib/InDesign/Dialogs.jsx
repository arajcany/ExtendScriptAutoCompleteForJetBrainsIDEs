...
var Dialogs = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new Dialog (Optional)
     * @return Dialog
     */
     ...
     *
     * @param {varies=any} [from] The Dialog, index, or name at the beginning of the range. Can accept: Dialog, Long Integer or String.
     * @param {varies=any} [to] The Dialog, index, or name at the end of the range. Can accept: Dialog, Long Integer or String.
     * @return Dialog
     */
