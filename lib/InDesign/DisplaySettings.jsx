...
var DisplaySettings = {
     ...
     *
     * @param {varies=any} [from] The DisplaySetting, index, or name at the beginning of the range. Can accept: DisplaySetting, Long Integer or String.
     * @param {varies=any} [to] The DisplaySetting, index, or name at the end of the range. Can accept: DisplaySetting, Long Integer or String.
     * @return DisplaySetting
     */
