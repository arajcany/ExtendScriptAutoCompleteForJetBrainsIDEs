...
var DocumentPresets = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new DocumentPreset (Optional)
     ...
     *
     * @param {varies=any} [from] The DocumentPreset, index, or name at the beginning of the range. Can accept: DocumentPreset, Long Integer or String.
     * @param {varies=any} [to] The DocumentPreset, index, or name at the end of the range. Can accept: DocumentPreset, Long Integer or String.
     * @return DocumentPreset
     */
