...
var DottedStrokeStyles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new DottedStrokeStyle (Optional)
     ...
     *
     * @param {varies=any} [from] The DottedStrokeStyle, index, or name at the beginning of the range. Can accept: DottedStrokeStyle, Long Integer or String.
     * @param {varies=any} [to] The DottedStrokeStyle, index, or name at the end of the range. Can accept: DottedStrokeStyle, Long Integer or String.
     * @return DottedStrokeStyle
     */
