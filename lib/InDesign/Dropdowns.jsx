...
var Dropdowns = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new Dropdown (Optional)
     * @return Dropdown
     */
     ...
     *
     * @param {varies=any} [from] The Dropdown, index, or name at the beginning of the range. Can accept: Dropdown, Long Integer or String.
     * @param {varies=any} [to] The Dropdown, index, or name at the end of the range. Can accept: Dropdown, Long Integer or String.
     * @return Dropdown
     */
