...
var EPSText = {
    ...
    /**
     * The parent of the EPSText (a Snippet, PlaceGun, ComboBox, ListBox, TextBox, SignatureField, Spread, MasterSpread, SplineItem, Polygon, GraphicLine, Rectangle, Oval, Group, State or Character).
     * @type {varies=any}
     * @readonly
     */
    parent: undefined,
    ...
    /**
     * If true, the EPSText's stroke color overprints any underlying objects. If false, the stroke color knocks out the  underlying colors.
     * @type {boolean}
     */
     ...
     * @param {Object} [withProperties] Initial values for properties of the new EPSText (Optional)
     * @return Asset
     */
     ...
     * Flips the EPSText.
     *
     * @param {Flip} [given] The axis around which to flip the EPSText.
     * @param {varies=any} [around] The point around which to flip the EPSText. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional)
     * @return undefined
     */
     ...
     *
     * @param {varies=any} [to] The location of the new EPSText, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] Amount by which to offset the new EPSText from the original EPSText's position. (Optional)
     * @return PageItem
     */
     ...
     *
     * @param {varies=any} [to] The new location of the EPSText,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] The amount (in measurement units) to move the EPSText relative to its current position, in the format (x, y). (Optional)
     * @return undefined
     */
    move: function (to, by) {
     ...
     * @param {boolean} [clearingOverrides] If true, clears the EPSText's existing attributes before applying the style. (Optional) (default: true)
     * @param {boolean} [clearingOverridesThroughRootObjectStyle] If true, clears attributes and formatting applied to the EPSText that are not defined in the object style. (Optional) (default: false)
     * @return undefined
     */
     ...
     *
     * @param {ConvertShapeOptions} [given] The EPSText's new shape.
     ...
     * @param {string} [withProperties] Initial values for properties of the new EPSText. Above parameters can also be passed as properties (Optional)
     * @return undefined
     */
     ...
     * Selects the object.
     *
     * @param {SelectionOptions} [existingSelection] The selection status of the EPSText in relation to previously selected objects. (Optional) (default: SelectionOptions.REPLACE_WITH)
     * @return undefined
     */
