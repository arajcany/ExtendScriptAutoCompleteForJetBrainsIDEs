...
var EPSTexts = {
     ...
     *
     * @param {varies=any} [from] The EPSText, index, or name at the beginning of the range. Can accept: EPSText, Long Integer or String.
     * @param {varies=any} [to] The EPSText, index, or name at the end of the range. Can accept: EPSText, Long Integer or String.
     * @return EPSText
     */
