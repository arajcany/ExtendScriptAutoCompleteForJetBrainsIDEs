...
var EPSs = {
     ...
     *
     * @param {varies=any} [from] The EPS, index, or name at the beginning of the range. Can accept: EPS, Long Integer or String.
     * @param {varies=any} [to] The EPS, index, or name at the end of the range. Can accept: EPS, Long Integer or String.
     * @return EPS
     */
