...
var EnablingGroups = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new EnablingGroup (Optional)
     ...
     *
     * @param {varies=any} [from] The EnablingGroup, index, or name at the beginning of the range. Can accept: EnablingGroup, Long Integer or String.
     * @param {varies=any} [to] The EnablingGroup, index, or name at the end of the range. Can accept: EnablingGroup, Long Integer or String.
     * @return EnablingGroup
     */
