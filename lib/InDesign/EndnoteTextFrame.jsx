 ...
 */
var EndnoteTextFrame = {


    /**
     * Dispatched before a EndnoteTextFrame is placed. This event bubbles. This event is cancelable.
     * @type {string}
     * @readonly
     */
    ...
    /**
     * Dispatched after a EndnoteTextFrame is placed. This event bubbles. This event is not cancelable.
     * @type {string}
     * @readonly
     */
     ...
     *
     * @param {ConvertShapeOptions} [given] The EndnoteTextFrame's new shape.
     ...
     * @param {Object} [withProperties] Initial values for properties of the new EndnoteTextFrame (Optional)
     * @return Asset
     */
     ...
     *
     * @param {Flip} [given] The axis around which to flip the EndnoteTextFrame.
     * @param {varies=any} [around] The point around which to flip the EndnoteTextFrame. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional)
     * @return undefined
     */
     ...
     *
     * @param {varies=any} [to] The location of the new EndnoteTextFrame, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] Amount by which to offset the new EndnoteTextFrame from the original EndnoteTextFrame's position. (Optional)
     * @return PageItem
     */
     ...
     *
     * @param {varies=any} [to] The new location of the EndnoteTextFrame,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] The amount (in measurement units) to move the EndnoteTextFrame relative to its current position, in the format (x, y). (Optional)
     * @return undefined
     */
    move: function (to, by) {
     ...
     * @param {boolean} [clearingOverrides] If true, clears the EndnoteTextFrame's existing attributes before applying the style. (Optional) (default: true)
     * @param {boolean} [clearingOverridesThroughRootObjectStyle] If true, clears attributes and formatting applied to the EndnoteTextFrame that are not defined in the object style. (Optional) (default: false)
     * @return undefined
     */
     ...
     * @param {string} [withProperties] Initial values for properties of the new EndnoteTextFrame. Above parameters can also be passed as properties (Optional)
     * @return undefined
     */
     ...
     * Selects the object.
     *
     * @param {SelectionOptions} [existingSelection] The selection status of the EndnoteTextFrame in relation to previously selected objects. (Optional) (default: SelectionOptions.REPLACE_WITH)
     * @return undefined
     */
