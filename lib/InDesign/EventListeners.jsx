...
var EventListeners = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new EventListener (Optional)
     ...
     *
     * @param {varies=any} [from] The EventListener, index, or name at the beginning of the range. Can accept: EventListener, Long Integer or String.
     * @param {varies=any} [to] The EventListener, index, or name at the end of the range. Can accept: EventListener, Long Integer or String.
     * @return EventListener
     */
