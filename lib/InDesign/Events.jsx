...
var Events = {
     ...
     *
     * @param {varies=any} [from] The Event, index, or name at the beginning of the range. Can accept: Event, Long Integer or String.
     * @param {varies=any} [to] The Event, index, or name at the end of the range. Can accept: Event, Long Integer or String.
     * @return Event
     */
