...
var FlattenerPresets = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new FlattenerPreset (Optional)
     ...
     *
     * @param {varies=any} [from] The FlattenerPreset, index, or name at the beginning of the range. Can accept: FlattenerPreset, Long Integer or String.
     * @param {varies=any} [to] The FlattenerPreset, index, or name at the end of the range. Can accept: FlattenerPreset, Long Integer or String.
     * @return FlattenerPreset
     */
