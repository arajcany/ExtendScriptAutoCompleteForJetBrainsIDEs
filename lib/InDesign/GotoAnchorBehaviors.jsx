...
var GotoAnchorBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GotoAnchorBehavior (Optional)
     * @return GotoAnchorBehavior
     */
     ...
     *
     * @param {varies=any} [from] The GotoAnchorBehavior, index, or name at the beginning of the range. Can accept: GotoAnchorBehavior, Long Integer or String.
     * @param {varies=any} [to] The GotoAnchorBehavior, index, or name at the end of the range. Can accept: GotoAnchorBehavior, Long Integer or String.
     * @return GotoAnchorBehavior
     */
