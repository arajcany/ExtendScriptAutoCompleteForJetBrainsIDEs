...
var GotoFirstPageBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GotoFirstPageBehavior (Optional)
     * @return GotoFirstPageBehavior
     */
     ...
     *
     * @param {varies=any} [from] The GotoFirstPageBehavior, index, or name at the beginning of the range. Can accept: GotoFirstPageBehavior, Long Integer or String.
     * @param {varies=any} [to] The GotoFirstPageBehavior, index, or name at the end of the range. Can accept: GotoFirstPageBehavior, Long Integer or String.
     * @return GotoFirstPageBehavior
     */
