...
var GotoLastPageBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GotoLastPageBehavior (Optional)
     * @return GotoLastPageBehavior
     */
     ...
     *
     * @param {varies=any} [from] The GotoLastPageBehavior, index, or name at the beginning of the range. Can accept: GotoLastPageBehavior, Long Integer or String.
     * @param {varies=any} [to] The GotoLastPageBehavior, index, or name at the end of the range. Can accept: GotoLastPageBehavior, Long Integer or String.
     * @return GotoLastPageBehavior
     */
