...
var GotoNextPageBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GotoNextPageBehavior (Optional)
     * @return GotoNextPageBehavior
     */
     ...
     *
     * @param {varies=any} [from] The GotoNextPageBehavior, index, or name at the beginning of the range. Can accept: GotoNextPageBehavior, Long Integer or String.
     * @param {varies=any} [to] The GotoNextPageBehavior, index, or name at the end of the range. Can accept: GotoNextPageBehavior, Long Integer or String.
     * @return GotoNextPageBehavior
     */
