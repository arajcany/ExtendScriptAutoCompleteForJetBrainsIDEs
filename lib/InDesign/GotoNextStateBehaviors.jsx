...
var GotoNextStateBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GotoNextStateBehavior (Optional)
     * @return GotoNextStateBehavior
     */
     ...
     *
     * @param {varies=any} [from] The GotoNextStateBehavior, index, or name at the beginning of the range. Can accept: GotoNextStateBehavior, Long Integer or String.
     * @param {varies=any} [to] The GotoNextStateBehavior, index, or name at the end of the range. Can accept: GotoNextStateBehavior, Long Integer or String.
     * @return GotoNextStateBehavior
     */
