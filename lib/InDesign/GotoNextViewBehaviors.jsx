...
var GotoNextViewBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GotoNextViewBehavior (Optional)
     * @return GotoNextViewBehavior
     */
     ...
     *
     * @param {varies=any} [from] The GotoNextViewBehavior, index, or name at the beginning of the range. Can accept: GotoNextViewBehavior, Long Integer or String.
     * @param {varies=any} [to] The GotoNextViewBehavior, index, or name at the end of the range. Can accept: GotoNextViewBehavior, Long Integer or String.
     * @return GotoNextViewBehavior
     */
