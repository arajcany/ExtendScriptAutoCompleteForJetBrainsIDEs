...
var GotoPageBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GotoPageBehavior (Optional)
     * @return GotoPageBehavior
     */
     ...
     *
     * @param {varies=any} [from] The GotoPageBehavior, index, or name at the beginning of the range. Can accept: GotoPageBehavior, Long Integer or String.
     * @param {varies=any} [to] The GotoPageBehavior, index, or name at the end of the range. Can accept: GotoPageBehavior, Long Integer or String.
     * @return GotoPageBehavior
     */
