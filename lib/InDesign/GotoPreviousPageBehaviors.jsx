...
var GotoPreviousPageBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GotoPreviousPageBehavior (Optional)
     * @return GotoPreviousPageBehavior
     */
     ...
     *
     * @param {varies=any} [from] The GotoPreviousPageBehavior, index, or name at the beginning of the range. Can accept: GotoPreviousPageBehavior, Long Integer or String.
     * @param {varies=any} [to] The GotoPreviousPageBehavior, index, or name at the end of the range. Can accept: GotoPreviousPageBehavior, Long Integer or String.
     * @return GotoPreviousPageBehavior
     */
