 ...
 */
var GotoPreviousStateBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GotoPreviousStateBehavior (Optional)
     * @return GotoPreviousStateBehavior
     */
     ...
     *
     * @param {varies=any} [from] The GotoPreviousStateBehavior, index, or name at the beginning of the range. Can accept: GotoPreviousStateBehavior, Long Integer or String.
     * @param {varies=any} [to] The GotoPreviousStateBehavior, index, or name at the end of the range. Can accept: GotoPreviousStateBehavior, Long Integer or String.
     * @return GotoPreviousStateBehavior
     */
