...
var GotoPreviousViewBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GotoPreviousViewBehavior (Optional)
     * @return GotoPreviousViewBehavior
     */
     ...
     *
     * @param {varies=any} [from] The GotoPreviousViewBehavior, index, or name at the beginning of the range. Can accept: GotoPreviousViewBehavior, Long Integer or String.
     * @param {varies=any} [to] The GotoPreviousViewBehavior, index, or name at the end of the range. Can accept: GotoPreviousViewBehavior, Long Integer or String.
     * @return GotoPreviousViewBehavior
     */
