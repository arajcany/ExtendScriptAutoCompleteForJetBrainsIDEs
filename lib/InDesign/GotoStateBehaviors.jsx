...
var GotoStateBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GotoStateBehavior (Optional)
     ...
     *
     * @param {varies=any} [from] The GotoStateBehavior, index, or name at the beginning of the range. Can accept: GotoStateBehavior, Long Integer or String.
     * @param {varies=any} [to] The GotoStateBehavior, index, or name at the end of the range. Can accept: GotoStateBehavior, Long Integer or String.
     * @return GotoStateBehavior
     */
