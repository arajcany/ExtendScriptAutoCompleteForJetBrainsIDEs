...
var GotoURLBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GotoURLBehavior (Optional)
     * @return GotoURLBehavior
     */
     ...
     *
     * @param {varies=any} [from] The GotoURLBehavior, index, or name at the beginning of the range. Can accept: GotoURLBehavior, Long Integer or String.
     * @param {varies=any} [to] The GotoURLBehavior, index, or name at the end of the range. Can accept: GotoURLBehavior, Long Integer or String.
     * @return GotoURLBehavior
     */
