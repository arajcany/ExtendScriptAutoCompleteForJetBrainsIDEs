...
var GradientStops = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new GradientStop (Optional)
     * @return GradientStop
     */
     ...
     *
     * @param {varies=any} [from] The GradientStop, index, or name at the beginning of the range. Can accept: GradientStop, Long Integer or String.
     * @param {varies=any} [to] The GradientStop, index, or name at the end of the range. Can accept: GradientStop, Long Integer or String.
     * @return GradientStop
     */
