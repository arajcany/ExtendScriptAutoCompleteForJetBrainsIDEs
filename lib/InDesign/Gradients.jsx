...
var Gradients = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new Gradient (Optional)
     * @return Gradient
     */
     ...
     *
     * @param {varies=any} [from] The Gradient, index, or name at the beginning of the range. Can accept: Gradient, Long Integer or String.
     * @param {varies=any} [to] The Gradient, index, or name at the end of the range. Can accept: Gradient, Long Integer or String.
     * @return Gradient
     */
