...
var Graphic = {
     ...
     * Flips the Graphic.
     *
     * @param {Flip} [given] The axis around which to flip the Graphic.
     * @param {varies=any} [around] The point around which to flip the Graphic. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional)
     * @return undefined
     */
     ...
     *
     * @param {varies=any} [to] The location of the new Graphic, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] Amount by which to offset the new Graphic from the original Graphic's position. (Optional)
     * @return PageItem
     */
     ...
     *
     * @param {varies=any} [to] The new location of the Graphic,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] The amount (in measurement units) to move the Graphic relative to its current position, in the format (x, y). (Optional)
     * @return undefined
     */
    move: function (to, by) {
     ...
     * @param {boolean} [clearingOverrides] If true, clears the Graphic's existing attributes before applying the style. (Optional) (default: true)
     * @param {boolean} [clearingOverridesThroughRootObjectStyle] If true, clears attributes and formatting applied to the Graphic that are not defined in the object style. (Optional) (default: false)
     * @return undefined
     */
     ...
     * @param {string} [withProperties] Initial values for properties of the new Graphic. Above parameters can also be passed as properties (Optional)
     * @return undefined
     */
     ...
     * @param {Object} [withProperties] Initial values for properties of the new Graphic (Optional)
     * @return Asset
     */
     ...
     *
     * @param {ConvertShapeOptions} [given] The Graphic's new shape.
     ...
     * Selects the object.
     *
     * @param {SelectionOptions} [existingSelection] The selection status of the Graphic in relation to previously selected objects. (Optional) (default: SelectionOptions.REPLACE_WITH)
     * @return undefined
     */
