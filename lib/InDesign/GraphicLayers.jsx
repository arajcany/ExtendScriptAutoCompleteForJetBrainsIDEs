...
var GraphicLayers = {
     ...
     *
     * @param {varies=any} [from] The GraphicLayer, index, or name at the beginning of the range. Can accept: GraphicLayer, Long Integer or String.
     * @param {varies=any} [to] The GraphicLayer, index, or name at the end of the range. Can accept: GraphicLayer, Long Integer or String.
     * @return GraphicLayer
     */
