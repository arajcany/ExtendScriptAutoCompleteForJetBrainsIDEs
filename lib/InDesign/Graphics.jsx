...
var Graphics = {
     ...
     *
     * @param {varies=any} [from] The Graphic, index, or name at the beginning of the range. Can accept: Graphic, Long Integer or String.
     * @param {varies=any} [to] The Graphic, index, or name at the end of the range. Can accept: Graphic, Long Integer or String.
     * @return Graphic
     */
