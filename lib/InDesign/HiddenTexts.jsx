...
var HiddenTexts = {
     ...
     *
     * @param {varies=any} [from] The HiddenText, index, or name at the beginning of the range. Can accept: HiddenText, Long Integer or String.
     * @param {varies=any} [to] The HiddenText, index, or name at the end of the range. Can accept: HiddenText, Long Integer or String.
     * @return HiddenText
     */
