 ...
 */
var HyperlinkExternalPageDestinations = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new HyperlinkExternalPageDestination (Optional)
     ...
     *
     * @param {varies=any} [from] The HyperlinkExternalPageDestination, index, or name at the beginning of the range. Can accept: HyperlinkExternalPageDestination, Long Integer or String.
     * @param {varies=any} [to] The HyperlinkExternalPageDestination, index, or name at the end of the range. Can accept: HyperlinkExternalPageDestination, Long Integer or String.
     * @return HyperlinkExternalPageDestination
     */
