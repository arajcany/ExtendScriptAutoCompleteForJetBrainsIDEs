...
var HyperlinkPageDestinations = {
     ...
     *
     * @param {Page} [destination] The document page that the hyperlink points to. (Optional)
     * @param {Object} [withProperties] Initial values for properties of the new HyperlinkPageDestination (Optional)
     ...
     *
     * @param {varies=any} [from] The HyperlinkPageDestination, index, or name at the beginning of the range. Can accept: HyperlinkPageDestination, Long Integer or String.
     * @param {varies=any} [to] The HyperlinkPageDestination, index, or name at the end of the range. Can accept: HyperlinkPageDestination, Long Integer or String.
     * @return HyperlinkPageDestination
     */
