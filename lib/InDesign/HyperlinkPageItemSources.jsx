...
var HyperlinkPageItemSources = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new HyperlinkPageItemSource (Optional)
     * @return HyperlinkPageItemSource
     */
     ...
     *
     * @param {varies=any} [from] The HyperlinkPageItemSource, index, or name at the beginning of the range. Can accept: HyperlinkPageItemSource, Long Integer or String.
     * @param {varies=any} [to] The HyperlinkPageItemSource, index, or name at the end of the range. Can accept: HyperlinkPageItemSource, Long Integer or String.
     * @return HyperlinkPageItemSource
     */
