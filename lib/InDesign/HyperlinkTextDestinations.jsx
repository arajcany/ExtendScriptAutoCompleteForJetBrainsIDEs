...
var HyperlinkTextDestinations = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new HyperlinkTextDestination (Optional)
     ...
     *
     * @param {varies=any} [from] The HyperlinkTextDestination, index, or name at the beginning of the range. Can accept: HyperlinkTextDestination, Long Integer or String.
     * @param {varies=any} [to] The HyperlinkTextDestination, index, or name at the end of the range. Can accept: HyperlinkTextDestination, Long Integer or String.
     * @return HyperlinkTextDestination
     */
