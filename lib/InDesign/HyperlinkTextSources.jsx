...
var HyperlinkTextSources = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new HyperlinkTextSource (Optional)
     ...
     *
     * @param {varies=any} [from] The HyperlinkTextSource, index, or name at the beginning of the range. Can accept: HyperlinkTextSource, Long Integer or String.
     * @param {varies=any} [to] The HyperlinkTextSource, index, or name at the end of the range. Can accept: HyperlinkTextSource, Long Integer or String.
     * @return HyperlinkTextSource
     */
