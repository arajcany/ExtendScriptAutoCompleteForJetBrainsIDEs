...
var HyperlinkURLDestinations = {
     ...
     *
     * @param {string} [destination] The URL that the hyperlink points to. (Optional)
     * @param {Object} [withProperties] Initial values for properties of the new HyperlinkURLDestination (Optional)
     * @return HyperlinkURLDestination
     */
     ...
     *
     * @param {varies=any} [from] The HyperlinkURLDestination, index, or name at the beginning of the range. Can accept: HyperlinkURLDestination, Long Integer or String.
     * @param {varies=any} [to] The HyperlinkURLDestination, index, or name at the end of the range. Can accept: HyperlinkURLDestination, Long Integer or String.
     * @return HyperlinkURLDestination
     */
