...
var Hyperlinks = {
     ...
     *
     * @param {varies=any} [hyperlinkSource] The hyperlinked object. Can accept: HyperlinkPageItemSource, HyperlinkTextSource or CrossReferenceSource.
     * @param {varies=any} [hyperlinkDestination] The destination that the hyperlink points to. Can accept: Ordered array containing fileName:String, volumn:String, directoryId:Long Integer, dataLinkClassId:Long Integer, destinationUid:Long Integer, HyperlinkTextDestination, HyperlinkPageDestination, HyperlinkExternalPageDestination, HyperlinkURLDestination or ParagraphDestination. (Optional)
     * @param {Object} [withProperties] Initial values for properties of the new Hyperlink (Optional)
     * @return Hyperlink
     */
     ...
     *
     * @param {varies=any} [from] The Hyperlink, index, or name at the beginning of the range. Can accept: Hyperlink, Long Integer or String.
     * @param {varies=any} [to] The Hyperlink, index, or name at the end of the range. Can accept: Hyperlink, Long Integer or String.
     * @return Hyperlink
     */
