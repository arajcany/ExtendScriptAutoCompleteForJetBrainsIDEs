...
var HyphenationExceptions = {
     ...
     *
     * @param {varies=any} [from] The HyphenationException, index, or name at the beginning of the range. Can accept: HyphenationException, Long Integer or String.
     * @param {varies=any} [to] The HyphenationException, index, or name at the end of the range. Can accept: HyphenationException, Long Integer or String.
     * @return HyphenationException
     */
