...
var IdleTasks = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new IdleTask (Optional)
     * @return IdleTask
     */
     ...
     *
     * @param {varies=any} [from] The IdleTask, index, or name at the beginning of the range. Can accept: IdleTask, Long Integer or String.
     * @param {varies=any} [to] The IdleTask, index, or name at the end of the range. Can accept: IdleTask, Long Integer or String.
     * @return IdleTask
     */
