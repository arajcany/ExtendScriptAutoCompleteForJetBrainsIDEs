...
var Images = {
     ...
     *
     * @param {varies=any} [from] The Image, index, or name at the beginning of the range. Can accept: Image, Long Integer or String.
     * @param {varies=any} [to] The Image, index, or name at the end of the range. Can accept: Image, Long Integer or String.
     * @return Image
     */
