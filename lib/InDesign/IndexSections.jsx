...
var IndexSections = {
     ...
     *
     * @param {varies=any} [from] The IndexSection, index, or name at the beginning of the range. Can accept: IndexSection, Long Integer or String.
     * @param {varies=any} [to] The IndexSection, index, or name at the end of the range. Can accept: IndexSection, Long Integer or String.
     * @return IndexSection
     */
