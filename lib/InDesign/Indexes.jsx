...
var Indexes = {
     ...
     * Creates a new Index.
     *
     * @param {Object} [withProperties] Initial values for properties of the new Index (Optional)
     * @return Index
     */
     ...
     *
     * @param {varies=any} [from] The Index, index, or name at the beginning of the range. Can accept: Index, Long Integer or String.
     * @param {varies=any} [to] The Index, index, or name at the end of the range. Can accept: Index, Long Integer or String.
     * @return Index
     */
