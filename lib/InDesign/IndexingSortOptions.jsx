...
var IndexingSortOptions = {
     ...
     *
     * @param {varies=any} [from] The IndexingSortOption, index, or name at the beginning of the range. Can accept: IndexingSortOption, Long Integer or String.
     * @param {varies=any} [to] The IndexingSortOption, index, or name at the end of the range. Can accept: IndexingSortOption, Long Integer or String.
     * @return IndexingSortOption
     */
