...
var InsertionPoint = {
     ...
     *
     * @param {string} [linkResourceURI] Resource URI for the link.
     * @param {string} [name] The tag name for the key. (Optional)
     * @return Link
     */
    createTextFragmentLink: function (linkResourceURI, name) {
     ...
     * @param {string} [withProperties] Initial values for properties of the new InsertionPoint. Above parameters can also be passed as properties (Optional)
     * @return undefined
     */
     ...
     * Selects the object.
     *
     * @param {SelectionOptions} [existingSelection] The selection status of the InsertionPoint in relation to previously selected objects. (Optional) (default: SelectionOptions.REPLACE_WITH)
     * @return undefined
     */
