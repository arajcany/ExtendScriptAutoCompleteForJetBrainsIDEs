...
var InsertionPoints = {
     ...
     *
     * @param {varies=any} [from] The InsertionPoint, index, or name at the beginning of the range. Can accept: InsertionPoint, Long Integer or String.
     * @param {varies=any} [to] The InsertionPoint, index, or name at the end of the range. Can accept: InsertionPoint, Long Integer or String.
     * @return InsertionPoint
     */
