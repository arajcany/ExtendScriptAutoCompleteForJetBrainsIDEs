...
var IntegerComboboxes = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new IntegerCombobox (Optional)
     * @return IntegerCombobox
     */
     ...
     *
     * @param {varies=any} [from] The IntegerCombobox, index, or name at the beginning of the range. Can accept: IntegerCombobox, Long Integer or String.
     * @param {varies=any} [to] The IntegerCombobox, index, or name at the end of the range. Can accept: IntegerCombobox, Long Integer or String.
     * @return IntegerCombobox
     */
