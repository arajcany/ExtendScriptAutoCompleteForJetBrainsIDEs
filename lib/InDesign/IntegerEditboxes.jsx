...
var IntegerEditboxes = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new IntegerEditbox (Optional)
     ...
     *
     * @param {varies=any} [from] The IntegerEditbox, index, or name at the beginning of the range. Can accept: IntegerEditbox, Long Integer or String.
     * @param {varies=any} [to] The IntegerEditbox, index, or name at the end of the range. Can accept: IntegerEditbox, Long Integer or String.
     * @return IntegerEditbox
     */
