...
var KinsokuTables = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new KinsokuTable (Optional)
     * @return KinsokuTable
     */
     ...
     *
     * @param {varies=any} [from] The KinsokuTable, index, or name at the beginning of the range. Can accept: KinsokuTable, Long Integer or String.
     * @param {varies=any} [to] The KinsokuTable, index, or name at the end of the range. Can accept: KinsokuTable, Long Integer or String.
     * @return KinsokuTable
     */
