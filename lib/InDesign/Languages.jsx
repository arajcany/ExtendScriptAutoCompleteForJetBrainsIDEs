...
var Languages = {
     ...
     *
     * @param {varies=any} [from] The Language, index, or name at the beginning of the range. Can accept: Language, Long Integer or String.
     * @param {varies=any} [to] The Language, index, or name at the end of the range. Can accept: Language, Long Integer or String.
     * @return Language
     */
