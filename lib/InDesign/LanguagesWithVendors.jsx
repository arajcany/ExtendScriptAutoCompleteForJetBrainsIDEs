...
var LanguagesWithVendors = {
     ...
     *
     * @param {varies=any} [from] The LanguageWithVendors, index, or name at the beginning of the range. Can accept: LanguageWithVendors, Long Integer or String.
     * @param {varies=any} [to] The LanguageWithVendors, index, or name at the end of the range. Can accept: LanguageWithVendors, Long Integer or String.
     * @return LanguageWithVendors
     */
