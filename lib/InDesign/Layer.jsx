...
var Layer = {
     ...
     * @param {Layer} [reference] The reference object. Note: Required when the to value specifies before or after. (Optional)
     * @return Layer
     */
     ...
     *
     * @param {Layer} [withXYZ] The layer(s) with which to merge.
     * @return Layer
     */
