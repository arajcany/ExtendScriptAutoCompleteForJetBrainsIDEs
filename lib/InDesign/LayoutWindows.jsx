...
var LayoutWindows = {
     ...
     *
     * @param {varies=any} [from] The LayoutWindow, index, or name at the beginning of the range. Can accept: LayoutWindow, Long Integer or String.
     * @param {varies=any} [to] The LayoutWindow, index, or name at the end of the range. Can accept: LayoutWindow, Long Integer or String.
     * @return LayoutWindow
     */
