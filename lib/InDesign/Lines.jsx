...
var Lines = {
     ...
     *
     * @param {varies=any} [from] The Line, index, or name at the beginning of the range. Can accept: Line, Long Integer or String.
     * @param {varies=any} [to] The Line, index, or name at the end of the range. Can accept: Line, Long Integer or String.
     * @return Line
     */
