...
var Links = {
     ...
     *
     * @param {varies=any} [from] The Link, index, or name at the beginning of the range. Can accept: Link, Long Integer or String.
     * @param {varies=any} [to] The Link, index, or name at the end of the range. Can accept: Link, Long Integer or String.
     * @return Link
     */
