...
var MasterSpreads = {
     ...
     *
     * @param {number} [pagesPerSpread] The number of pages to include in the master spread. (Optional)
     * @param {Object} [withProperties] Initial values for properties of the new MasterSpread (Optional)
     * @return MasterSpread
     */
     ...
     *
     * @param {varies=any} [from] The MasterSpread, index, or name at the beginning of the range. Can accept: MasterSpread, Long Integer or String.
     * @param {varies=any} [to] The MasterSpread, index, or name at the end of the range. Can accept: MasterSpread, Long Integer or String.
     * @return MasterSpread
     */
