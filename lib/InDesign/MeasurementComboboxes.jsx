...
var MeasurementComboboxes = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new MeasurementCombobox (Optional)
     ...
     *
     * @param {varies=any} [from] The MeasurementCombobox, index, or name at the beginning of the range. Can accept: MeasurementCombobox, Long Integer or String.
     * @param {varies=any} [to] The MeasurementCombobox, index, or name at the end of the range. Can accept: MeasurementCombobox, Long Integer or String.
     * @return MeasurementCombobox
     */
