...
var MeasurementEditboxes = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new MeasurementEditbox (Optional)
     * @return MeasurementEditbox
     */
     ...
     *
     * @param {varies=any} [from] The MeasurementEditbox, index, or name at the beginning of the range. Can accept: MeasurementEditbox, Long Integer or String.
     * @param {varies=any} [to] The MeasurementEditbox, index, or name at the end of the range. Can accept: MeasurementEditbox, Long Integer or String.
     * @return MeasurementEditbox
     */
