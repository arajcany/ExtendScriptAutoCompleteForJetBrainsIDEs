...
var MediaItems = {
     ...
     *
     * @param {varies=any} [from] The MediaItem, index, or name at the beginning of the range. Can accept: MediaItem, Long Integer or String.
     * @param {varies=any} [to] The MediaItem, index, or name at the end of the range. Can accept: MediaItem, Long Integer or String.
     * @return MediaItem
     */
