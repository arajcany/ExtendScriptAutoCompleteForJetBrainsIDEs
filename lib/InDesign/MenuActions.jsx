...
var MenuActions = {
     ...
     *
     * @param {varies=any} [from] The MenuAction, index, or name at the beginning of the range. Can accept: MenuAction, Long Integer or String.
     * @param {varies=any} [to] The MenuAction, index, or name at the end of the range. Can accept: MenuAction, Long Integer or String.
     * @return MenuAction
     */
