...
var MenuElements = {
     ...
     *
     * @param {varies=any} [from] The MenuElement, index, or name at the beginning of the range. Can accept: MenuElement, Long Integer or String.
     * @param {varies=any} [to] The MenuElement, index, or name at the end of the range. Can accept: MenuElement, Long Integer or String.
     * @return MenuElement
     */
