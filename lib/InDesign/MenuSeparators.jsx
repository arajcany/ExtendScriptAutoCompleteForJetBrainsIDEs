...
var MenuSeparators = {
     ...
     *
     * @param {LocationOptions} [at] The location of the menu separator relative to the reference object or within the containing object. (Optional) (default: LocationOptions.AT_END)
     * @param {MenuElement} [reference] The reference object. Note: Required when the at parameter specifies before or after. (Optional)
     * @param {Object} [withProperties] Initial values for properties of the new MenuSeparator (Optional)
     ...
     *
     * @param {varies=any} [from] The MenuSeparator, index, or name at the beginning of the range. Can accept: MenuSeparator, Long Integer or String.
     * @param {varies=any} [to] The MenuSeparator, index, or name at the end of the range. Can accept: MenuSeparator, Long Integer or String.
     * @return MenuSeparator
     */
