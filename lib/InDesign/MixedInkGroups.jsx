...
var MixedInkGroups = {
     ...
     * @param {number} [inkPercentages] The percent of each ink in the ink list. (Range: 0 to 100 for each ink) (Optional)
     * @param {number} [repeatValues] The number of repetitions for each ink in the ink list. (Range: 0 to 100 for each ink) (Optional)
     * @param {number} [incrementValues] The increment percent per repetition for each ink. (Range: 0 to 100) Note: The cumulative ink percentage per ink cannot exceed 100.) (Optional)
     * @param {Object} [withProperties] Initial values for properties of the new MixedInkGroup (Optional)
     ...
     *
     * @param {varies=any} [from] The MixedInkGroup, index, or name at the beginning of the range. Can accept: MixedInkGroup, Long Integer or String.
     * @param {varies=any} [to] The MixedInkGroup, index, or name at the end of the range. Can accept: MixedInkGroup, Long Integer or String.
     * @return MixedInkGroup
     */
