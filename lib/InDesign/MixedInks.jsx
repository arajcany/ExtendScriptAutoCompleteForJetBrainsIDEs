...
var MixedInks = {
     ...
     *
     * @param {varies=any} [inkList] The inks to mix. Note: Must contain at least two process inks and one spot ink. Can accept: Array of Inks or MixedInkGroup.
     * @param {number} [inkPercentages] The percent to use of each ink in the ink list. (Range: 0 to 100 for each ink)
     * @param {Object} [withProperties] Initial values for properties of the new MixedInk (Optional)
     * @return MixedInk
     */
     ...
     *
     * @param {varies=any} [from] The MixedInk, index, or name at the beginning of the range. Can accept: MixedInk, Long Integer or String.
     * @param {varies=any} [to] The MixedInk, index, or name at the end of the range. Can accept: MixedInk, Long Integer or String.
     * @return MixedInk
     */
