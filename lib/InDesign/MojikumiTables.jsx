...
var MojikumiTables = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new MojikumiTable (Optional)
     ...
     *
     * @param {varies=any} [from] The MojikumiTable, index, or name at the beginning of the range. Can accept: MojikumiTable, Long Integer or String.
     * @param {varies=any} [to] The MojikumiTable, index, or name at the end of the range. Can accept: MojikumiTable, Long Integer or String.
     * @return MojikumiTable
     */
