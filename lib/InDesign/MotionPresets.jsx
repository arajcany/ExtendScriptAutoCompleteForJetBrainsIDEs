...
var MotionPresets = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new MotionPreset (Optional)
     * @return MotionPreset
     */
     ...
     *
     * @param {varies=any} [from] The MotionPreset, index, or name at the beginning of the range. Can accept: MotionPreset, Long Integer or String.
     * @param {varies=any} [to] The MotionPreset, index, or name at the end of the range. Can accept: MotionPreset, Long Integer or String.
     * @return MotionPreset
     */
