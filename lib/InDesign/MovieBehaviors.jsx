...
var MovieBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new MovieBehavior (Optional)
     ...
     *
     * @param {varies=any} [from] The MovieBehavior, index, or name at the beginning of the range. Can accept: MovieBehavior, Long Integer or String.
     * @param {varies=any} [to] The MovieBehavior, index, or name at the end of the range. Can accept: MovieBehavior, Long Integer or String.
     * @return MovieBehavior
     */
