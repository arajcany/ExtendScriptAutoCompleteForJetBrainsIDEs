...
var MultiStateObject = {
    ...
    /**
     * The parent of the MultiStateObject (a Snippet, PlaceGun, Spread, MasterSpread, SplineItem, Polygon, GraphicLine, Rectangle, Oval, Group or Character).
     * @type {varies=any}
     * @readonly
     */
    parent: undefined,
    ...
    /**
     * Determines if this object is initially hidden when displayed in an exported file.
     * @type {boolean}
     */
    ...
    /**
     * If true, the MultiStateObject's stroke color overprints any underlying objects. If false, the stroke color knocks out the  underlying colors.
     * @type {boolean}
     */
     ...
     *
     * @param {ConvertShapeOptions} [given] The MultiStateObject's new shape.
     ...
     *
     * @param {PageItem} [pageitems] One or more page items to add as a state.
     * @return undefined
     */
    addItemsAsState: function (pageitems) {
     ...
     *
     * @param {Flip} [given] The axis around which to flip the MultiStateObject.
     * @param {varies=any} [around] The point around which to flip the MultiStateObject. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional)
     * @return undefined
     */
     ...
     *
     * @param {varies=any} [to] The location of the new MultiStateObject, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] Amount by which to offset the new MultiStateObject from the original MultiStateObject's position. (Optional)
     * @return PageItem
     */
     ...
     *
     * @param {varies=any} [to] The new location of the MultiStateObject,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] The amount (in measurement units) to move the MultiStateObject relative to its current position, in the format (x, y). (Optional)
     * @return undefined
     */
    move: function (to, by) {
     ...
     * @param {boolean} [clearingOverrides] If true, clears the MultiStateObject's existing attributes before applying the style. (Optional) (default: true)
     * @param {boolean} [clearingOverridesThroughRootObjectStyle] If true, clears attributes and formatting applied to the MultiStateObject that are not defined in the object style. (Optional) (default: false)
     * @return undefined
     */
     ...
     * @param {string} [withProperties] Initial values for properties of the new MultiStateObject. Above parameters can also be passed as properties (Optional)
     * @return undefined
     */
     ...
     * Selects the object.
     *
     * @param {SelectionOptions} [existingSelection] The selection status of the MultiStateObject in relation to previously selected objects. (Optional) (default: SelectionOptions.REPLACE_WITH)
     * @return undefined
     */
