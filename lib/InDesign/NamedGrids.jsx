...
var NamedGrids = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new NamedGrid (Optional)
     * @return NamedGrid
     */
     ...
     *
     * @param {varies=any} [from] The NamedGrid, index, or name at the beginning of the range. Can accept: NamedGrid, Long Integer or String.
     * @param {varies=any} [to] The NamedGrid, index, or name at the end of the range. Can accept: NamedGrid, Long Integer or String.
     * @return NamedGrid
     */
