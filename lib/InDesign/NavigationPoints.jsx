...
var NavigationPoints = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new NavigationPoint (Optional)
     ...
     *
     * @param {varies=any} [from] The NavigationPoint, index, or name at the beginning of the range. Can accept: NavigationPoint, Long Integer or String.
     * @param {varies=any} [to] The NavigationPoint, index, or name at the end of the range. Can accept: NavigationPoint, Long Integer or String.
     * @return NavigationPoint
     */
