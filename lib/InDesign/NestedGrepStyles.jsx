...
var NestedGrepStyles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new NestedGrepStyle (Optional)
     ...
     *
     * @param {varies=any} [from] The NestedGrepStyle, index, or name at the beginning of the range. Can accept: NestedGrepStyle, Long Integer or String.
     * @param {varies=any} [to] The NestedGrepStyle, index, or name at the end of the range. Can accept: NestedGrepStyle, Long Integer or String.
     * @return NestedGrepStyle
     */
