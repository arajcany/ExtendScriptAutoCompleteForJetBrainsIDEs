...
var NestedLineStyles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new NestedLineStyle (Optional)
     ...
     *
     * @param {varies=any} [from] The NestedLineStyle, index, or name at the beginning of the range. Can accept: NestedLineStyle, Long Integer or String.
     * @param {varies=any} [to] The NestedLineStyle, index, or name at the end of the range. Can accept: NestedLineStyle, Long Integer or String.
     * @return NestedLineStyle
     */
