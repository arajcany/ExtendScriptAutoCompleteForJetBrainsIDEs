...
var NestedStyles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new NestedStyle (Optional)
     * @return NestedStyle
     */
     ...
     *
     * @param {varies=any} [from] The NestedStyle, index, or name at the beginning of the range. Can accept: NestedStyle, Long Integer or String.
     * @param {varies=any} [to] The NestedStyle, index, or name at the end of the range. Can accept: NestedStyle, Long Integer or String.
     * @return NestedStyle
     */
