...
var NumberingLists = {
     ...
     * @param {boolean} [continueNumbersAcrossStories] If true, numbering will continue across stories. (Optional)
     * @param {boolean} [continueNumbersAcrossDocuments] If true, numbering will continue across book documents. (Optional)
     * @param {Object} [withProperties] Initial values for properties of the new NumberingList (Optional)
     ...
     *
     * @param {varies=any} [from] The NumberingList, index, or name at the beginning of the range. Can accept: NumberingList, Long Integer or String.
     * @param {varies=any} [to] The NumberingList, index, or name at the end of the range. Can accept: NumberingList, Long Integer or String.
     * @return NumberingList
     */
