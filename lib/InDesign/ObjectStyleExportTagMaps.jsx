...
var ObjectStyleExportTagMaps = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new ObjectStyleExportTagMap (Optional)
     ...
     *
     * @param {varies=any} [from] The ObjectStyleExportTagMap, index, or name at the beginning of the range. Can accept: ObjectStyleExportTagMap, Long Integer or String.
     * @param {varies=any} [to] The ObjectStyleExportTagMap, index, or name at the end of the range. Can accept: ObjectStyleExportTagMap, Long Integer or String.
     * @return ObjectStyleExportTagMap
     */
