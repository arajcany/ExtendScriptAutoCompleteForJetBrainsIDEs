...
var ObjectStyleGroups = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new ObjectStyleGroup (Optional)
     ...
     *
     * @param {varies=any} [from] The ObjectStyleGroup, index, or name at the beginning of the range. Can accept: ObjectStyleGroup, Long Integer or String.
     * @param {varies=any} [to] The ObjectStyleGroup, index, or name at the end of the range. Can accept: ObjectStyleGroup, Long Integer or String.
     * @return ObjectStyleGroup
     */
