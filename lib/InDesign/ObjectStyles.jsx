...
var ObjectStyles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new ObjectStyle (Optional)
     * @return ObjectStyle
     */
     ...
     *
     * @param {varies=any} [from] The ObjectStyle, index, or name at the beginning of the range. Can accept: ObjectStyle, Long Integer or String.
     * @param {varies=any} [to] The ObjectStyle, index, or name at the end of the range. Can accept: ObjectStyle, Long Integer or String.
     * @return ObjectStyle
     */
