...
var OpacityGradientStops = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new OpacityGradientStop (Optional)
     ...
     *
     * @param {varies=any} [from] The OpacityGradientStop, index, or name at the beginning of the range. Can accept: OpacityGradientStop, Long Integer or String.
     * @param {varies=any} [to] The OpacityGradientStop, index, or name at the end of the range. Can accept: OpacityGradientStop, Long Integer or String.
     * @return OpacityGradientStop
     */
