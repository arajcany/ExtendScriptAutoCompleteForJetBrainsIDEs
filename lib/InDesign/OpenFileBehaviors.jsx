...
var OpenFileBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new OpenFileBehavior (Optional)
     ...
     *
     * @param {varies=any} [from] The OpenFileBehavior, index, or name at the beginning of the range. Can accept: OpenFileBehavior, Long Integer or String.
     * @param {varies=any} [to] The OpenFileBehavior, index, or name at the end of the range. Can accept: OpenFileBehavior, Long Integer or String.
     * @return OpenFileBehavior
     */
