...
var PDFExportPresets = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new PDFExportPreset (Optional)
     ...
     *
     * @param {varies=any} [from] The PDFExportPreset, index, or name at the beginning of the range. Can accept: PDFExportPreset, Long Integer or String.
     * @param {varies=any} [to] The PDFExportPreset, index, or name at the end of the range. Can accept: PDFExportPreset, Long Integer or String.
     * @return PDFExportPreset
     */
