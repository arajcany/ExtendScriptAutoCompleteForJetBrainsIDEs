...
var PDFs = {
     ...
     *
     * @param {varies=any} [from] The PDF, index, or name at the beginning of the range. Can accept: PDF, Long Integer or String.
     * @param {varies=any} [to] The PDF, index, or name at the end of the range. Can accept: PDF, Long Integer or String.
     * @return PDF
     */
