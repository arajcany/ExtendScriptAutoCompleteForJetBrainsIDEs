...
var PICTs = {
     ...
     *
     * @param {varies=any} [from] The PICT, index, or name at the beginning of the range. Can accept: PICT, Long Integer or String.
     * @param {varies=any} [to] The PICT, index, or name at the end of the range. Can accept: PICT, Long Integer or String.
     * @return PICT
     */
