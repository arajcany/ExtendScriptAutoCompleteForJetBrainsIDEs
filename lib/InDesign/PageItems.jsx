...
var PageItems = {
     ...
     *
     * @param {varies=any} [from] The PageItem, index, or name at the beginning of the range. Can accept: PageItem, Long Integer or String.
     * @param {varies=any} [to] The PageItem, index, or name at the end of the range. Can accept: PageItem, Long Integer or String.
     * @return PageItem
     */
