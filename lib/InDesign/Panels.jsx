...
var Panels = {
     ...
     *
     * @param {varies=any} [from] The Panel, index, or name at the beginning of the range. Can accept: Panel, Long Integer or String.
     * @param {varies=any} [to] The Panel, index, or name at the end of the range. Can accept: Panel, Long Integer or String.
     * @return Panel
     */
