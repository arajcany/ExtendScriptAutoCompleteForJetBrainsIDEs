...
var ParaStyleMappings = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new ParaStyleMapping (Optional)
     ...
     *
     * @param {varies=any} [from] The ParaStyleMapping, index, or name at the beginning of the range. Can accept: ParaStyleMapping, Long Integer or String.
     * @param {varies=any} [to] The ParaStyleMapping, index, or name at the end of the range. Can accept: ParaStyleMapping, Long Integer or String.
     * @return ParaStyleMapping
     */
