...
var Paragraph = {
     ...
     * @readonly
     */
    bulletsAndNumberingResultText: undefined,
     ...
     * @readonly
     */
    numberingResultNumber: undefined,
     ...
     * @param {string} [withProperties] Initial values for properties of the new Paragraph. Above parameters can also be passed as properties (Optional)
     * @return undefined
     */
     ...
     * Selects the object.
     *
     * @param {SelectionOptions} [existingSelection] The selection status of the Paragraph in relation to previously selected objects. (Optional) (default: SelectionOptions.REPLACE_WITH)
     * @return undefined
     */
