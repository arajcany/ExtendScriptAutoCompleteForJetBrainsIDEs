...
var ParagraphDestinations = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new ParagraphDestination (Optional)
     ...
     *
     * @param {varies=any} [from] The ParagraphDestination, index, or name at the beginning of the range. Can accept: ParagraphDestination, Long Integer or String.
     * @param {varies=any} [to] The ParagraphDestination, index, or name at the end of the range. Can accept: ParagraphDestination, Long Integer or String.
     * @return ParagraphDestination
     */
