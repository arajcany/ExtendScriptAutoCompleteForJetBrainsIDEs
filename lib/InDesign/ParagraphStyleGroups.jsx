...
var ParagraphStyleGroups = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new ParagraphStyleGroup (Optional)
     ...
     *
     * @param {varies=any} [from] The ParagraphStyleGroup, index, or name at the beginning of the range. Can accept: ParagraphStyleGroup, Long Integer or String.
     * @param {varies=any} [to] The ParagraphStyleGroup, index, or name at the end of the range. Can accept: ParagraphStyleGroup, Long Integer or String.
     * @return ParagraphStyleGroup
     */
