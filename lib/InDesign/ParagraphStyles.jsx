...
var ParagraphStyles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new ParagraphStyle (Optional)
     ...
     *
     * @param {varies=any} [from] The ParagraphStyle, index, or name at the beginning of the range. Can accept: ParagraphStyle, Long Integer or String.
     * @param {varies=any} [to] The ParagraphStyle, index, or name at the end of the range. Can accept: ParagraphStyle, Long Integer or String.
     * @return ParagraphStyle
     */
