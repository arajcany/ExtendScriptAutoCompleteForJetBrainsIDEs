...
var Paragraphs = {
     ...
     *
     * @param {varies=any} [from] The Paragraph, index, or name at the beginning of the range. Can accept: Paragraph, Long Integer or String.
     * @param {varies=any} [to] The Paragraph, index, or name at the end of the range. Can accept: Paragraph, Long Integer or String.
     * @return Paragraph
     */
