...
var PathPoints = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new PathPoint (Optional)
     * @return PathPoint
     */
     ...
     *
     * @param {varies=any} [from] The PathPoint, index, or name at the beginning of the range. Can accept: PathPoint, Long Integer or String.
     * @param {varies=any} [to] The PathPoint, index, or name at the end of the range. Can accept: PathPoint, Long Integer or String.
     * @return PathPoint
     */
