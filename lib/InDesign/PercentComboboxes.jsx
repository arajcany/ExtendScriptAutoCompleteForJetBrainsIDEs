...
var PercentComboboxes = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new PercentCombobox (Optional)
     ...
     *
     * @param {varies=any} [from] The PercentCombobox, index, or name at the beginning of the range. Can accept: PercentCombobox, Long Integer or String.
     * @param {varies=any} [to] The PercentCombobox, index, or name at the end of the range. Can accept: PercentCombobox, Long Integer or String.
     * @return PercentCombobox
     */
