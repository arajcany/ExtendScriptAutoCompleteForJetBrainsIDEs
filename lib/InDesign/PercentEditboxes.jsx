...
var PercentEditboxes = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new PercentEditbox (Optional)
     * @return PercentEditbox
     */
     ...
     *
     * @param {varies=any} [from] The PercentEditbox, index, or name at the beginning of the range. Can accept: PercentEditbox, Long Integer or String.
     * @param {varies=any} [to] The PercentEditbox, index, or name at the end of the range. Can accept: PercentEditbox, Long Integer or String.
     * @return PercentEditbox
     */
