...
var Preferences = {
     ...
     *
     * @param {varies=any} [from] The Preference, index, or name at the beginning of the range. Can accept: Preference, Long Integer or String.
     * @param {varies=any} [to] The Preference, index, or name at the end of the range. Can accept: Preference, Long Integer or String.
     * @return Preference
     */
