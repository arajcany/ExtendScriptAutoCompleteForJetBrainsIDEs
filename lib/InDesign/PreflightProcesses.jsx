...
var PreflightProcesses = {
     ...
     * @param {PreflightOption} [preflightOptions] The preflight options that should be used. (Optional)
     * @param {Object} [withProperties] Initial values for properties of the new PreflightProcess (Optional)
     ...
     *
     * @param {varies=any} [from] The PreflightProcess, index, or name at the beginning of the range. Can accept: PreflightProcess, Long Integer or String.
     * @param {varies=any} [to] The PreflightProcess, index, or name at the end of the range. Can accept: PreflightProcess, Long Integer or String.
     * @return PreflightProcess
     */
