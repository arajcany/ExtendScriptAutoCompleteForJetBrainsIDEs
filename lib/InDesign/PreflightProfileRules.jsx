...
var PreflightProfileRules = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new PreflightProfileRule (Optional)
     * @return varies=any
     */
     ...
     *
     * @param {varies=any} [from] The PreflightProfileRule, index, or name at the beginning of the range. Can accept: PreflightProfileRule, Long Integer or String.
     * @param {varies=any} [to] The PreflightProfileRule, index, or name at the end of the range. Can accept: PreflightProfileRule, Long Integer or String.
     * @return PreflightProfileRule
     */
