...
var PreflightProfiles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new PreflightProfile (Optional)
     ...
     *
     * @param {varies=any} [from] The PreflightProfile, index, or name at the beginning of the range. Can accept: PreflightProfile, Long Integer or String.
     * @param {varies=any} [to] The PreflightProfile, index, or name at the end of the range. Can accept: PreflightProfile, Long Integer or String.
     * @return PreflightProfile
     */
