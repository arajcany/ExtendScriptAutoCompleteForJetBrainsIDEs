...
var PreflightRuleInstances = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new PreflightRuleInstance (Optional)
     * @return varies=any
     */
     ...
     *
     * @param {varies=any} [from] The PreflightRuleInstance, index, or name at the beginning of the range. Can accept: PreflightRuleInstance, Long Integer or String.
     * @param {varies=any} [to] The PreflightRuleInstance, index, or name at the end of the range. Can accept: PreflightRuleInstance, Long Integer or String.
     * @return PreflightRuleInstance
     */
