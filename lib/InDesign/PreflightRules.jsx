...
var PreflightRules = {
     ...
     *
     * @param {varies=any} [from] The PreflightRule, index, or name at the beginning of the range. Can accept: PreflightRule, Long Integer or String.
     * @param {varies=any} [to] The PreflightRule, index, or name at the end of the range. Can accept: PreflightRule, Long Integer or String.
     * @return PreflightRule
     */
