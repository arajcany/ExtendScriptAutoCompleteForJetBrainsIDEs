...
var PrintFormBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new PrintFormBehavior (Optional)
     * @return PrintFormBehavior
     */
     ...
     *
     * @param {varies=any} [from] The PrintFormBehavior, index, or name at the beginning of the range. Can accept: PrintFormBehavior, Long Integer or String.
     * @param {varies=any} [to] The PrintFormBehavior, index, or name at the end of the range. Can accept: PrintFormBehavior, Long Integer or String.
     * @return PrintFormBehavior
     */
