...
var PrinterPresets = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new PrinterPreset (Optional)
     ...
     *
     * @param {varies=any} [from] The PrinterPreset, index, or name at the beginning of the range. Can accept: PrinterPreset, Long Integer or String.
     * @param {varies=any} [to] The PrinterPreset, index, or name at the end of the range. Can accept: PrinterPreset, Long Integer or String.
     * @return PrinterPreset
     */
