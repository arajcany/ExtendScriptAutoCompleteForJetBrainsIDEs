...
var RadiobuttonControls = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new RadiobuttonControl (Optional)
     ...
     *
     * @param {varies=any} [from] The RadiobuttonControl, index, or name at the beginning of the range. Can accept: RadiobuttonControl, Long Integer or String.
     * @param {varies=any} [to] The RadiobuttonControl, index, or name at the end of the range. Can accept: RadiobuttonControl, Long Integer or String.
     * @return RadiobuttonControl
     */
