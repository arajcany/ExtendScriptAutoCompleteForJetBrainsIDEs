...
var RadiobuttonGroups = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new RadiobuttonGroup (Optional)
     ...
     *
     * @param {varies=any} [from] The RadiobuttonGroup, index, or name at the beginning of the range. Can accept: RadiobuttonGroup, Long Integer or String.
     * @param {varies=any} [to] The RadiobuttonGroup, index, or name at the end of the range. Can accept: RadiobuttonGroup, Long Integer or String.
     * @return RadiobuttonGroup
     */
