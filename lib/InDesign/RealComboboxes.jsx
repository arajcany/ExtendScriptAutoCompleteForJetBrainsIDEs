...
var RealComboboxes = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new RealCombobox (Optional)
     * @return RealCombobox
     */
     ...
     *
     * @param {varies=any} [from] The RealCombobox, index, or name at the beginning of the range. Can accept: RealCombobox, Long Integer or String.
     * @param {varies=any} [to] The RealCombobox, index, or name at the end of the range. Can accept: RealCombobox, Long Integer or String.
     * @return RealCombobox
     */
