...
var RealEditboxes = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new RealEditbox (Optional)
     * @return RealEditbox
     */
     ...
     *
     * @param {varies=any} [from] The RealEditbox, index, or name at the beginning of the range. Can accept: RealEditbox, Long Integer or String.
     * @param {varies=any} [to] The RealEditbox, index, or name at the end of the range. Can accept: RealEditbox, Long Integer or String.
     * @return RealEditbox
     */
