...
var RuleDataObjects = {
     ...
     * @param {varies=any} [dataValue] The value of data. Can accept: String, Real, Long Integer, Short Integer, Boolean, Object or Array of Strings, Reals, Long Integers, Short Integers, Booleans, Objects or Arrays of Array of Arrays of Array of Strings, Reals, Long Integers, Short Integers, Booleans or Objects.
     * @param {Object} [withProperties] Initial values for properties of the new RuleDataObject (Optional)
     ...
     *
     * @param {varies=any} [from] The RuleDataObject, index, or name at the beginning of the range. Can accept: RuleDataObject, Long Integer or String.
     * @param {varies=any} [to] The RuleDataObject, index, or name at the end of the range. Can accept: RuleDataObject, Long Integer or String.
     * @return RuleDataObject
     */
