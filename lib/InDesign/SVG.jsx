...
var SVG = {
    ...
    /**
     * Dispatched before a SVG is placed. This event bubbles. This event is cancelable.
     * @type {string}
     * @readonly
     */
    ...
    /**
     * Dispatched after a SVG is placed. This event bubbles. This event is not cancelable.
     * @type {string}
     * @readonly
     */
    ...
    /**
     * The XML element associated with the SVG.
     * @type {XMLItem}
     * @readonly
     */
    ...
    /**
     * Transparency settings for the fill applied to the SVG.
    ...
    /**
     * Transparency settings for the content of the SVG.
    ...
    /**
     * Lists all page items contained by the SVG.
     * @type {PageItem}
     * @readonly
     */
    ...
    /**
     * Lists all graphics contained by the SVG.
     * @type {Graphic}
     * @readonly
     */
    allGraphics: Graphic,
    ...
    /**
     * The parent of the SVG (a TextBox, SignatureField, ComboBox, ListBox, PageItem, HtmlItem, FormField, RadioButton, CheckBox, MultiStateObject, Button, MediaItem, Sound, Movie, EPSText, SplineItem, Polygon, GraphicLine, Rectangle, Oval, Graphic, SVG, ImportedPage, PICT, WMF, PDF, EPS, Image, Group, TextFrame, EndnoteTextFrame, State, PlaceGun, XMLElement or Snippet).
     * @type {varies=any}
     * @readonly
     */
    parent: undefined,
    ...
    /**
     * The index of the SVG within its containing object.
     * @type {number}
     * @readonly
     */
    index: undefined,
    ...
    /**
     * If true, the SVG does not print.
     * @type {boolean}
     */
    ...
    /**
     * The bounds of the SVG excluding the stroke width, in the format [y1, x1, y2, x2], which give the coordinates of the top-left and bottom-right corners of the bounding box.
    ...
    /**
     * The bounds of the SVG including the stroke width, in the format [y1, x1, y2, x2], which give the coordinates of the top-left and bottom-right corners of the bounding box.
     * @type {Measurement Unit (Number or String)=any}
     */
    ...
    /**
     * Display performance options for the SVG.
    ...
    /**
     * The rotatation angle of the SVG. (Range: -360 to 360)
     * @type {number}
     */
    ...
    /**
     * The skewing angle applied to the SVG. (Range: -360 to 360)
     * @type {number}
     */
    ...
    /**
     * The horizontal scaling applied to the SVG.
     * @type {number}
     */
    ...
    /**
     * The vertical scaling applied to the SVG.
     * @type {number}
     */
    ...
    /**
     * The rotation angle of the SVG relative to its containing object. (Range: -360 to 360)
     * @type {number}
     */
    ...
    /**
     * The skewing angle of the SVG relative to its containing object. (Range: -360 to 360)
     * @type {number}
     */
    ...
    /**
     * The horizontal scale of the SVG relative to its containing object.
     * @type {number}
     */
    ...
    /**
     * The vertical scale of the SVG relative to its containing object.
     * @type {number}
     */
    ...
    /**
     * The object style applied to the SVG.
     * @type {ObjectStyle}
     */
    ...
    /**
     * Indicates whether the SVG has been flipped independently of its parent object and, if yes, the direction in which the SVG was flipped.
     * @type {Flip}
     */
    absoluteFlip: Flip,
    ...
    /**
     * The swatch (color, gradient, tint, or mixed ink) applied to the fill of the SVG. . Can also accept: String.
     * @type {Swatch}
     */
    fillColor: Swatch,
    ...
    /**
     * The percent of tint to use in the SVG's fill color. (To specify a tint percent, use a number in the range of 0 to 100; to use the inherited or overridden value, use -1.)
     * @type {number}
     */
    fillTint: undefined,
    ...
    /**
     * If true, the SVG's fill color overprints any underlying objects. If false, the fill color knocks out the underlying colors.
     * @type {boolean}
     */
    ...
    /**
     * The weight (in points) to apply to the SVG's stroke.
     * @type {Measurement Unit (Number or String)=any}
     */
    ...
    /**
     * The corner join applied to the SVG.
     * @type {EndJoin}
     */
    endJoin: EndJoin,
    ...
    /**
     * The corner adjustment applied to the SVG.
    ...
    /**
     * The swatch (color, gradient, tint, or mixed ink) applied to the stroke of the SVG. Can also accept: String.
     * @type {Swatch}
     */
    strokeColor: Swatch,
    ...
    /**
     * The starting point (in page coordinates) of a gradient applied to the fill of the SVG, in the format [x, y].
     * @type {Measurement Unit (Number or String)=any}
     */
    ...
    /**
     * The length (for a linear gradient) or radius (for a radial gradient) applied to the fill of the SVG.
     * @type {Measurement Unit (Number or String)=any}
     */
    ...
    /**
     * The angle of a linear gradient applied to the fill of the SVG. (Range: -180 to 180)
     * @type {number}
     */
    ...
    /**
     * The starting point (in page coordinates) of a gradient applied to the stroke of the SVG, in the format [x, y].
     * @type {Measurement Unit (Number or String)=any}
     */
    ...
    /**
     * The length (for a linear gradient) or radius (for a radial gradient) applied to the stroke of the SVG.
     * @type {Measurement Unit (Number or String)=any}
     */
    ...
    /**
     * The angle of a linear gradient applied to the stroke of the SVG. (Range: -180 to 180)
     * @type {number}
     */
    ...
    /**
     * If true, the SVG's stroke color overprints any underlying objects. If false, the stroke color knocks out the  underlying colors.
     * @type {boolean}
     */
    ...
    /**
     * The stroke alignment applied to the SVG.
    ...
    /**
     * The arrowhead alignment applied to the SVG.
     ...
     * Flips the SVG.
     *
     * @param {Flip} [given] The axis around which to flip the SVG.
     * @param {varies=any} [around] The point around which to flip the SVG. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional)
     * @return undefined
     */
    ...
    /**
     * Duplicates the SVG at the specified location or offset.
     *
     * @param {varies=any} [to] The location of the new SVG, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] Amount by which to offset the new SVG from the original SVG's position. (Optional)
     * @return PageItem
     */
    ...
    /**
     * Moves the SVG to a new location. Note: Either the 'to' or 'by' parameter is required; if both parameters are defined, only the to value is used.
     *
     * @param {varies=any} [to] The new location of the SVG,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] The amount (in measurement units) to move the SVG relative to its current position, in the format (x, y). (Optional)
     * @return undefined
     */
    move: function (to, by) {
     ...
     * @param {boolean} [clearingOverrides] If true, clears the SVG's existing attributes before applying the style. (Optional) (default: true)
     * @param {boolean} [clearingOverridesThroughRootObjectStyle] If true, clears attributes and formatting applied to the SVG that are not defined in the object style. (Optional) (default: false)
     * @return undefined
     */
    ...
    /**
     * Transforms the SVG using the last transformation performed on any object. Transformations include moving, rotating, shearing, scaling, and flipping.
     *
     * @return string
     */
    ...
    /**
     * Transforms the SVG using the last sequence of transform operations performed on any single object or performed at the same time on any group of objects. Transformations include moving, rotating, shearing, scaling, and flipping.
     *
     * @return string
     */
    ...
    /**
     * Transforms the SVG using the last transformation performed on any SVG. Transformations include moving, rotating, shearing, scaling, and flipping.
     *
     * @return string
     */
    ...
    /**
     * Transforms the SVG using the last sequence of transformations performed on any single object or performed at the same time on any group of objects. Transformations include moving, rotating, shearing, scaling, and flipping.
     *
     * @return string
     */
     ...
     * @param {string} [withProperties] Initial values for properties of the new SVG. Above parameters can also be passed as properties (Optional)
     * @return undefined
     */
     ...
     * @param {Object} [withProperties] Initial values for properties of the new SVG (Optional)
     * @return Asset
     */
    ...
    /**
     * Converts the SVG to a different shape.
     *
     * @param {ConvertShapeOptions} [given] The SVG's new shape.
    ...
    /**
     * Clears transformations from the SVG. Transformations include rotation, scaling, flipping, fitting, and shearing.
     *
     * @return undefined
     */
     ...
     * Selects the object.
     *
     * @param {SelectionOptions} [existingSelection] The selection status of the SVG in relation to previously selected objects. (Optional) (default: SelectionOptions.REPLACE_WITH)
     * @return undefined
     */
