...
var ScriptMenuActions = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new ScriptMenuAction (Optional)
     ...
     *
     * @param {varies=any} [from] The ScriptMenuAction, index, or name at the beginning of the range. Can accept: ScriptMenuAction, Long Integer or String.
     * @param {varies=any} [to] The ScriptMenuAction, index, or name at the end of the range. Can accept: ScriptMenuAction, Long Integer or String.
     * @return ScriptMenuAction
     */
