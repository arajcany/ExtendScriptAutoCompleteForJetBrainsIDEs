...
var ShowHideFieldsBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new ShowHideFieldsBehavior (Optional)
     ...
     *
     * @param {varies=any} [from] The ShowHideFieldsBehavior, index, or name at the beginning of the range. Can accept: ShowHideFieldsBehavior, Long Integer or String.
     * @param {varies=any} [to] The ShowHideFieldsBehavior, index, or name at the end of the range. Can accept: ShowHideFieldsBehavior, Long Integer or String.
     * @return ShowHideFieldsBehavior
     */
