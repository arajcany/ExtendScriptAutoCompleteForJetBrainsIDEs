...
var SignatureField = {
    ...
    /**
     * The parent of the SignatureField (a Snippet, PlaceGun, Character, Spread, MasterSpread, SplineItem, Polygon, GraphicLine, Rectangle, Oval or Group).
     * @type {varies=any}
     * @readonly
     */
    parent: undefined,
    ...
    /**
     * If true, the SignatureField's stroke color overprints any underlying objects. If false, the stroke color knocks out the  underlying colors.
     * @type {boolean}
     */
     ...
     *
     * @param {ConvertShapeOptions} [given] The SignatureField's new shape.
     ...
     * @param {Object} [withProperties] Initial values for properties of the new SignatureField (Optional)
     * @return Asset
     */
     ...
     *
     * @param {Flip} [given] The axis around which to flip the SignatureField.
     * @param {varies=any} [around] The point around which to flip the SignatureField. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional)
     * @return undefined
     */
     ...
     *
     * @param {varies=any} [to] The location of the new SignatureField, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] Amount by which to offset the new SignatureField from the original SignatureField's position. (Optional)
     * @return PageItem
     */
     ...
     *
     * @param {varies=any} [to] The new location of the SignatureField,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] The amount (in measurement units) to move the SignatureField relative to its current position, in the format (x, y). (Optional)
     * @return undefined
     */
    move: function (to, by) {
     ...
     * @param {boolean} [clearingOverrides] If true, clears the SignatureField's existing attributes before applying the style. (Optional) (default: true)
     * @param {boolean} [clearingOverridesThroughRootObjectStyle] If true, clears attributes and formatting applied to the SignatureField that are not defined in the object style. (Optional) (default: false)
     * @return undefined
     */
     ...
     * @param {string} [withProperties] Initial values for properties of the new SignatureField. Above parameters can also be passed as properties (Optional)
     * @return undefined
     */
     ...
     * Selects the object.
     *
     * @param {SelectionOptions} [existingSelection] The selection status of the SignatureField in relation to previously selected objects. (Optional) (default: SelectionOptions.REPLACE_WITH)
     * @return undefined
     */
