...
var SoundBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new SoundBehavior (Optional)
     ...
     *
     * @param {varies=any} [from] The SoundBehavior, index, or name at the beginning of the range. Can accept: SoundBehavior, Long Integer or String.
     * @param {varies=any} [to] The SoundBehavior, index, or name at the end of the range. Can accept: SoundBehavior, Long Integer or String.
     * @return SoundBehavior
     */
