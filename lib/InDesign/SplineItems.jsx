...
var SplineItems = {
     ...
     *
     * @param {varies=any} [from] The SplineItem, index, or name at the beginning of the range. Can accept: SplineItem, Long Integer or String.
     * @param {varies=any} [to] The SplineItem, index, or name at the end of the range. Can accept: SplineItem, Long Integer or String.
     * @return SplineItem
     */
