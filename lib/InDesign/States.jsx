...
var States = {
     ...
     * Creates a new State.
     *
     * @param {Object} [withProperties] Initial values for properties of the new State (Optional)
     * @return State
     */
     ...
     *
     * @param {varies=any} [from] The State, index, or name at the beginning of the range. Can accept: State, Long Integer or String.
     * @param {varies=any} [to] The State, index, or name at the end of the range. Can accept: State, Long Integer or String.
     * @return State
     */
