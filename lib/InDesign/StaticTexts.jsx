...
var StaticTexts = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new StaticText (Optional)
     * @return StaticText
     */
     ...
     *
     * @param {varies=any} [from] The StaticText, index, or name at the beginning of the range. Can accept: StaticText, Long Integer or String.
     * @param {varies=any} [to] The StaticText, index, or name at the end of the range. Can accept: StaticText, Long Integer or String.
     * @return StaticText
     */
