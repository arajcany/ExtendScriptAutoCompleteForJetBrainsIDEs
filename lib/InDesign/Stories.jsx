...
var Stories = {
     ...
     *
     * @param {varies=any} [from] The Story, index, or name at the beginning of the range. Can accept: Story, Long Integer or String.
     * @param {varies=any} [to] The Story, index, or name at the end of the range. Can accept: Story, Long Integer or String.
     * @return Story
     */
