...
var StoryWindows = {
     ...
     *
     * @param {varies=any} [from] The StoryWindow, index, or name at the beginning of the range. Can accept: StoryWindow, Long Integer or String.
     * @param {varies=any} [to] The StoryWindow, index, or name at the end of the range. Can accept: StoryWindow, Long Integer or String.
     * @return StoryWindow
     */
