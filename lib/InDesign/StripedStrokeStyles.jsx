...
var StripedStrokeStyles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new StripedStrokeStyle (Optional)
     ...
     *
     * @param {varies=any} [from] The StripedStrokeStyle, index, or name at the beginning of the range. Can accept: StripedStrokeStyle, Long Integer or String.
     * @param {varies=any} [to] The StripedStrokeStyle, index, or name at the end of the range. Can accept: StripedStrokeStyle, Long Integer or String.
     * @return StripedStrokeStyle
     */
