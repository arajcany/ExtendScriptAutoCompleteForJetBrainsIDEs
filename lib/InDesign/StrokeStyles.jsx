...
var StrokeStyles = {
     ...
     *
     * @param {varies=any} [from] The StrokeStyle, index, or name at the beginning of the range. Can accept: StrokeStyle, Long Integer or String.
     * @param {varies=any} [to] The StrokeStyle, index, or name at the end of the range. Can accept: StrokeStyle, Long Integer or String.
     * @return StrokeStyle
     */
