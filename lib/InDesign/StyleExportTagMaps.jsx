...
var StyleExportTagMaps = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new StyleExportTagMap (Optional)
     ...
     *
     * @param {varies=any} [from] The StyleExportTagMap, index, or name at the beginning of the range. Can accept: StyleExportTagMap, Long Integer or String.
     * @param {varies=any} [to] The StyleExportTagMap, index, or name at the end of the range. Can accept: StyleExportTagMap, Long Integer or String.
     * @return StyleExportTagMap
     */
