...
var SubmitFormBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new SubmitFormBehavior (Optional)
     * @return SubmitFormBehavior
     */
     ...
     *
     * @param {varies=any} [from] The SubmitFormBehavior, index, or name at the beginning of the range. Can accept: SubmitFormBehavior, Long Integer or String.
     * @param {varies=any} [to] The SubmitFormBehavior, index, or name at the end of the range. Can accept: SubmitFormBehavior, Long Integer or String.
     * @return SubmitFormBehavior
     */
