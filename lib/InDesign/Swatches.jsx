...
var Swatches = {
     ...
     *
     * @param {varies=any} [from] The Swatch, index, or name at the beginning of the range. Can accept: Swatch, Long Integer or String.
     * @param {varies=any} [to] The Swatch, index, or name at the end of the range. Can accept: Swatch, Long Integer or String.
     * @return Swatch
     */
