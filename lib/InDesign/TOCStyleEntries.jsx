...
var TOCStyleEntries = {
     ...
     *
     * @param {string} [styleName] The paragraph style to include as TOC entries in the TOC. (Optional)
     * @param {Object} [withProperties] Initial values for properties of the new TOCStyleEntry (Optional)
     ...
     *
     * @param {varies=any} [from] The TOCStyleEntry, index, or name at the beginning of the range. Can accept: TOCStyleEntry, Long Integer or String.
     * @param {varies=any} [to] The TOCStyleEntry, index, or name at the end of the range. Can accept: TOCStyleEntry, Long Integer or String.
     * @return TOCStyleEntry
     */
