...
var TOCStyles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new TOCStyle (Optional)
     * @return TOCStyle
     */
     ...
     *
     * @param {varies=any} [from] The TOCStyle, index, or name at the beginning of the range. Can accept: TOCStyle, Long Integer or String.
     * @param {varies=any} [to] The TOCStyle, index, or name at the end of the range. Can accept: TOCStyle, Long Integer or String.
     * @return TOCStyle
     */
