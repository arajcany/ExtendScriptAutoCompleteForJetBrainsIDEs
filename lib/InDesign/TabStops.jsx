...
var TabStops = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new TabStop (Optional)
     * @return TabStop
     */
     ...
     *
     * @param {varies=any} [from] The TabStop, index, or name at the beginning of the range. Can accept: TabStop, Long Integer or String.
     * @param {varies=any} [to] The TabStop, index, or name at the end of the range. Can accept: TabStop, Long Integer or String.
     * @return TabStop
     */
