...
var TableStyleGroups = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new TableStyleGroup (Optional)
     ...
     *
     * @param {varies=any} [from] The TableStyleGroup, index, or name at the beginning of the range. Can accept: TableStyleGroup, Long Integer or String.
     * @param {varies=any} [to] The TableStyleGroup, index, or name at the end of the range. Can accept: TableStyleGroup, Long Integer or String.
     * @return TableStyleGroup
     */
