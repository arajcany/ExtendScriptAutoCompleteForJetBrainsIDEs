...
var TableStyleMappings = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new TableStyleMapping (Optional)
     ...
     *
     * @param {varies=any} [from] The TableStyleMapping, index, or name at the beginning of the range. Can accept: TableStyleMapping, Long Integer or String.
     * @param {varies=any} [to] The TableStyleMapping, index, or name at the end of the range. Can accept: TableStyleMapping, Long Integer or String.
     * @return TableStyleMapping
     */
