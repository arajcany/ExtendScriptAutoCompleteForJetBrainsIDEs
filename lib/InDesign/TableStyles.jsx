...
var TableStyles = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new TableStyle (Optional)
     * @return TableStyle
     */
     ...
     *
     * @param {varies=any} [from] The TableStyle, index, or name at the beginning of the range. Can accept: TableStyle, Long Integer or String.
     * @param {varies=any} [to] The TableStyle, index, or name at the end of the range. Can accept: TableStyle, Long Integer or String.
     * @return TableStyle
     */
