...
var TextBox = {
    ...
    /**
     * The parent of the TextBox (a Snippet, PlaceGun, Character, Spread, MasterSpread, SplineItem, Polygon, GraphicLine, Rectangle, Oval or Group).
     * @type {varies=any}
     * @readonly
     */
    parent: undefined,
    ...
    /**
     * If true, the TextBox's stroke color overprints any underlying objects. If false, the stroke color knocks out the  underlying colors.
     * @type {boolean}
     */
     ...
     *
     * @param {ConvertShapeOptions} [given] The TextBox's new shape.
     ...
     * Flips the TextBox.
     *
     * @param {Flip} [given] The axis around which to flip the TextBox.
     * @param {varies=any} [around] The point around which to flip the TextBox. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional)
     * @return undefined
     */
     ...
     *
     * @param {varies=any} [to] The location of the new TextBox, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] Amount by which to offset the new TextBox from the original TextBox's position. (Optional)
     * @return PageItem
     */
     ...
     *
     * @param {varies=any} [to] The new location of the TextBox,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional)
     * @param {Measurement Unit (Number or String)=any} [by] The amount (in measurement units) to move the TextBox relative to its current position, in the format (x, y). (Optional)
     * @return undefined
     */
    move: function (to, by) {
     ...
     * @param {boolean} [clearingOverrides] If true, clears the TextBox's existing attributes before applying the style. (Optional) (default: true)
     * @param {boolean} [clearingOverridesThroughRootObjectStyle] If true, clears attributes and formatting applied to the TextBox that are not defined in the object style. (Optional) (default: false)
     * @return undefined
     */
     ...
     * @param {string} [withProperties] Initial values for properties of the new TextBox. Above parameters can also be passed as properties (Optional)
     * @return undefined
     */
     ...
     * Selects the object.
     *
     * @param {SelectionOptions} [existingSelection] The selection status of the TextBox in relation to previously selected objects. (Optional) (default: SelectionOptions.REPLACE_WITH)
     * @return undefined
     */
