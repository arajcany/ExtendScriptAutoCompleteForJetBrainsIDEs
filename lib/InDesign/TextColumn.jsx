...
var TextColumn = {
    ...
    /**
     * The parent of the TextColumn (a XmlStory, TextPath, TextFrame, EndnoteTextFrame, Text, InsertionPoint, TextStyleRange, Paragraph, TextColumn, Line, Word, Character, Story, Cell, XMLElement, Endnote, Footnote, Note, Change or HiddenText).
     * @type {varies=any}
     * @readonly
     */
    parent: undefined,
    ...
    /**
     * The corner join applied to the TextColumn.
     * @type {EndJoin}
     */
     ...
     * @param {string} [withProperties] Initial values for properties of the new TextColumn. Above parameters can also be passed as properties (Optional)
     * @return undefined
     */
     ...
     * Selects the object.
     *
     * @param {SelectionOptions} [existingSelection] The selection status of the TextColumn in relation to previously selected objects. (Optional) (default: SelectionOptions.REPLACE_WITH)
     * @return undefined
     */
