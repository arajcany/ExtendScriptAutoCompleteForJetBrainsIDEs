...
var TextColumns = {
     ...
     *
     * @param {varies=any} [from] The TextColumn, index, or name at the beginning of the range. Can accept: TextColumn, Long Integer or String.
     * @param {varies=any} [to] The TextColumn, index, or name at the end of the range. Can accept: TextColumn, Long Integer or String.
     * @return TextColumn
     */
