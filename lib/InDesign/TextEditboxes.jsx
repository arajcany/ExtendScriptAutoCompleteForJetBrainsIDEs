...
var TextEditboxes = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new TextEditbox (Optional)
     * @return TextEditbox
     */
     ...
     *
     * @param {varies=any} [from] The TextEditbox, index, or name at the beginning of the range. Can accept: TextEditbox, Long Integer or String.
     * @param {varies=any} [to] The TextEditbox, index, or name at the end of the range. Can accept: TextEditbox, Long Integer or String.
     * @return TextEditbox
     */
