...
var TextPaths = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new TextPath (Optional)
     * @return TextPath
     */
     ...
     *
     * @param {varies=any} [from] The TextPath, index, or name at the beginning of the range. Can accept: TextPath, Long Integer or String.
     * @param {varies=any} [to] The TextPath, index, or name at the end of the range. Can accept: TextPath, Long Integer or String.
     * @return TextPath
     */
