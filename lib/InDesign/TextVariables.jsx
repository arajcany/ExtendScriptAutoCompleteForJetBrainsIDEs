...
var TextVariables = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new TextVariable (Optional)
     * @return TextVariable
     */
     ...
     *
     * @param {varies=any} [from] The TextVariable, index, or name at the beginning of the range. Can accept: TextVariable, Long Integer or String.
     * @param {varies=any} [to] The TextVariable, index, or name at the end of the range. Can accept: TextVariable, Long Integer or String.
     * @return TextVariable
     */
