...
var Texts = {
     ...
     *
     * @param {varies=any} [from] The Text, index, or name at the beginning of the range. Can accept: Text, Long Integer or String.
     * @param {varies=any} [to] The Text, index, or name at the end of the range. Can accept: Text, Long Integer or String.
     * @return Text
     */
