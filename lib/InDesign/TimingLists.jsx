...
var TimingLists = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new TimingList (Optional)
     * @return TimingList
     */
     ...
     *
     * @param {varies=any} [from] The TimingList, index, or name at the beginning of the range. Can accept: TimingList, Long Integer or String.
     * @param {varies=any} [to] The TimingList, index, or name at the end of the range. Can accept: TimingList, Long Integer or String.
     * @return TimingList
     */
