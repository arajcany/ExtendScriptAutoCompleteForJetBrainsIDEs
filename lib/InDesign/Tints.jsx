...
var Tints = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new Tint (Optional)
     * @return Tint
     */
     ...
     *
     * @param {varies=any} [from] The Tint, index, or name at the beginning of the range. Can accept: Tint, Long Integer or String.
     * @param {varies=any} [to] The Tint, index, or name at the end of the range. Can accept: Tint, Long Integer or String.
     * @return Tint
     */
