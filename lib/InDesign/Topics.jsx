...
var Topics = {
     ...
     * @param {string} [sortBy] The string to sort this topic by instead of the topic name. Note: The actual topic text, rather than the sort order text, appears in the index. (Optional)
     * @param {Object} [withProperties] Initial values for properties of the new Topic (Optional)
     * @return Topic
     */
     ...
     *
     * @param {varies=any} [from] The Topic, index, or name at the beginning of the range. Can accept: Topic, Long Integer or String.
     * @param {varies=any} [to] The Topic, index, or name at the end of the range. Can accept: Topic, Long Integer or String.
     * @return Topic
     */
