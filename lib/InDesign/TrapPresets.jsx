...
var TrapPresets = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new TrapPreset (Optional)
     * @return TrapPreset
     */
     ...
     *
     * @param {varies=any} [from] The TrapPreset, index, or name at the beginning of the range. Can accept: TrapPreset, Long Integer or String.
     * @param {varies=any} [to] The TrapPreset, index, or name at the end of the range. Can accept: TrapPreset, Long Integer or String.
     * @return TrapPreset
     */
