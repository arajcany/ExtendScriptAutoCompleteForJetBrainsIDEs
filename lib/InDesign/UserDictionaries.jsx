...
var UserDictionaries = {
     ...
     *
     * @param {varies=any} [from] The UserDictionary, index, or name at the beginning of the range. Can accept: UserDictionary, Long Integer or String.
     * @param {varies=any} [to] The UserDictionary, index, or name at the end of the range. Can accept: UserDictionary, Long Integer or String.
     * @return UserDictionary
     */
