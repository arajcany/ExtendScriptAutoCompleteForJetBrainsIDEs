...
var ValidationErrors = {
     ...
     *
     * @param {varies=any} [from] The ValidationError, index, or name at the beginning of the range. Can accept: ValidationError, Long Integer or String.
     * @param {varies=any} [to] The ValidationError, index, or name at the end of the range. Can accept: ValidationError, Long Integer or String.
     * @return ValidationError
     */
