...
var ViewZoomBehaviors = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new ViewZoomBehavior (Optional)
     * @return ViewZoomBehavior
     */
     ...
     *
     * @param {varies=any} [from] The ViewZoomBehavior, index, or name at the beginning of the range. Can accept: ViewZoomBehavior, Long Integer or String.
     * @param {varies=any} [to] The ViewZoomBehavior, index, or name at the end of the range. Can accept: ViewZoomBehavior, Long Integer or String.
     * @return ViewZoomBehavior
     */
