...
var Widgets = {
     ...
     *
     * @param {varies=any} [from] The Widget, index, or name at the beginning of the range. Can accept: Widget, Long Integer or String.
     * @param {varies=any} [to] The Widget, index, or name at the end of the range. Can accept: Widget, Long Integer or String.
     * @return Widget
     */
