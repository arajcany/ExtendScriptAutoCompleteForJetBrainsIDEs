...
var Windows = {
     ...
     *
     * @param {Object} [withProperties] Initial values for properties of the new Window (Optional)
     * @return Window
     */
     ...
     *
     * @param {varies=any} [from] The Window, index, or name at the beginning of the range. Can accept: Window, Long Integer or String.
     * @param {varies=any} [to] The Window, index, or name at the end of the range. Can accept: Window, Long Integer or String.
     * @return Window
     */
