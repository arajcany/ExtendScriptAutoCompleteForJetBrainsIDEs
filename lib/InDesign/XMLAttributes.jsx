...
var XMLAttributes = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new XMLAttribute (Optional)
     * @return XMLAttribute
     */
     ...
     *
     * @param {varies=any} [from] The XMLAttribute, index, or name at the beginning of the range. Can accept: XMLAttribute, Long Integer or String.
     * @param {varies=any} [to] The XMLAttribute, index, or name at the end of the range. Can accept: XMLAttribute, Long Integer or String.
     * @return XMLAttribute
     */
