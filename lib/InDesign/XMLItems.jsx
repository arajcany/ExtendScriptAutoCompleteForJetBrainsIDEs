...
var XMLItems = {
     ...
     *
     * @param {varies=any} [from] The XMLItem, index, or name at the beginning of the range. Can accept: XMLItem, Long Integer or String.
     * @param {varies=any} [to] The XMLItem, index, or name at the end of the range. Can accept: XMLItem, Long Integer or String.
     * @return XMLItem
     */
