...
var XMLRuleProcessors = {
     ...
     * @param {Object} [withProperties] Initial values for properties of the new XMLRuleProcessor (Optional)
     ...
     *
     * @param {varies=any} [from] The XMLRuleProcessor, index, or name at the beginning of the range. Can accept: XMLRuleProcessor, Long Integer or String.
     * @param {varies=any} [to] The XMLRuleProcessor, index, or name at the end of the range. Can accept: XMLRuleProcessor, Long Integer or String.
     * @return XMLRuleProcessor
     */
