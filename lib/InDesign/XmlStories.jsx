...
var XmlStories = {
     ...
     *
     * @param {varies=any} [from] The XmlStory, index, or name at the beginning of the range. Can accept: XmlStory, Long Integer or String.
     * @param {varies=any} [to] The XmlStory, index, or name at the end of the range. Can accept: XmlStory, Long Integer or String.
     * @return XmlStory
     */
